...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.000001, 0, 0, 0.000001, 0.00000001, 0, 0, 0.000001, 0.00002, 0.03, 0.000001, 0, 2, 0.001, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "aguda_b_1999"
        self.curve_names = [
            "Chk1P",
            "Rad3",
            "p53",
        ...
        self.state_names = ['Chk1P', 'Rad3', 'p53', 'preMPF', 'MPF', 'p21', 'p21_MPF', 'iCdc25', 'iCdc25Ps216', 'iCdc25Ps216_protein1433', 'aCdc25', 'aCdc25Ps216', 'protein1433', 'Wee1', 'Wee1P']
        self.algebraic_names = ['Chk1', 'V_5', 'V_11', 'V_9', 'V_2', 'V_8', 'aCdc25_T', 'V_1', 'V_n9', 'V_n2', 'V_n8', 'V_n1', 'V_14', 'V_15', 'V_2_', 'V_17', 'V_20', 'V_3_', 'V_22', 'V_n3_', 'V_18', 'V_23', 'V_7', 'V_n18', 'V_ex', 'V_6', 'V_n23', 'V_n7', 'V_12']
        self.params = param
        self.T = T
        self.T_unit = T_unit
