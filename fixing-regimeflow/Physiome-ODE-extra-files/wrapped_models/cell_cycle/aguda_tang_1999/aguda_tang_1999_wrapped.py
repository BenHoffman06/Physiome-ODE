...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0, 0.01, 1.95, 0, 0.05, 0, 5, 1, 0, 5, 0.01],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "aguda_tang_1999"
        self.curve_names = [
            "a_CyclinE_Cdk2",
            "i_CyclinE_Cdk2",
            "pRB_E2F",
        ...
        self.state_names = ['a_CyclinE_Cdk2', 'i_CyclinE_Cdk2', 'pRB_E2F', 'E2F', 'pRB', 'CycD_Cdk4', 'p27', 'CycE_Cdk2_p27', 'CycD_Cdk4_p27', 'p16', 'pRB_P']
        self.algebraic_names = ['V_2', 'V_1', 'V_n2', 'V_n4', 'V_26', 'V_3', 'V_18', 'V_28', 'V_n6', 'V_5', 'V_29', 'V_8', 'V_9', 'V_10', 'V_21', 'V_17', 'V_19', 'V_24', 'V_20', 'V_25', 'V_22']
        self.params = param
        self.T = T
        self.T_unit = T_unit
