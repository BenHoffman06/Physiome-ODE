...
class Parameters:
    ...
    def to_dict(self):
        return {
            ...
            "k_ih1p": self.k_ih1p,
            "k_ih1pp": self.k_ih1pp,
            "k_ih1ppp": self.k_ih1ppp,
            "k_ih1pppp": self.k_ih1pppp,
            "k_ih1ppppp": self.k_ih1ppppp,
            "J_ah1": self.J_ah1,
            "J_ih1": self.J_ih1,
            "mu": self.mu,
            "maxmass": self.maxmass,
            "k_atfp": self.k_atfp,
            "k_atfpp": self.k_atfpp,
            "k_atfppp": self.k_atfppp,
            "k_atfpppp": self.k_atfpppp,
            "k_itfp": self.k_itfp,
            "k_itfpp": self.k_itfpp,
            "k_itfppp": self.k_itfppp,
            "J_itf": self.J_itf,
            "J_atf": self.J_atf,
            "k_dep": self.k_dep,
            "k_depp": self.k_depp,
            "k_deppp": self.k_deppp,
            "k_depppp": self.k_depppp,
            "k_dap": self.k_dap,
            "k_dapp": self.k_dapp,
            "k_dappp": self.k_dappp,
            "k_afi": self.k_afi,
            "k_ifip": self.k_ifip,
            "k_ifipp": self.k_ifipp,
            "J_ifi": self.J_ifi,
            "J_afi": self.J_afi,
            "k_sip": self.k_sip,
            "k_sipp": self.k_sipp,
            "k_dip": self.k_dip,
            "k_dipp": self.k_dipp,
            "k_dippp": self.k_dippp,
            "k_dipppp": self.k_dipppp,
            "k_dippppp": self.k_dippppp,
            "J_14di": self.J_14di,
            "k_afb": self.k_afb,
            "k_ifb": self.k_ifb,
            "J_ifb": self.J_ifb,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.09450308233499527, 1.338267803192139, 0.1903585940599442, 0.09450308233499527, 0.01, 0.01, 0.2092024385929108, 0.09450308233499527, 0.09450308233499527, 0.3572723865509033, 0.07591402530670166, 0.7702387571334839, 0.01, 0.7189393639564514],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "csikasz_nagy_2006_budding_yeast_from_paper"
        self.curve_names = [
            "actCycA",
            "mass",
            "actCycB",
        ...
        self.state_names = ['actCycA', 'mass', 'actCycB', 'CycB', 'Tri_B', 'preMPF', 'actCycE', 'CycA', 'CycE', 'Cdc20_A', 'APCP', 'Cdc20_T', 'CKI', 'Cdh1']
        self.algebraic_names = ['CycD', 'Tri_A', 'Tri_E', 'freeCKI', 'V_atf', 'A1', 'A2', 'TF_E', 'V_de', 'V_da', 'A2_1', 'Cdc14', 'A1_1', 'TF_I', 'V_si', 'V_di', 'A1_2', 'TF_B', 'V_sb', 'V_db', 'A1_3', 'A2_2', 'Wee1', 'V_wee', 'A1_4', 'A2_3', 'Cdc25', 'V_25']
        self.params = param
        self.T = T
        self.T_unit = T_unit
