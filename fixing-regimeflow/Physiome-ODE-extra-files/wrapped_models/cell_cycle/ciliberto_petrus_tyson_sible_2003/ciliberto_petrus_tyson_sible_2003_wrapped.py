...
class Parameters:
    ...
    def to_dict(self):
        return {
            ...
            "koff": self.koff,
            "kassoc": self.kassoc,
            "kdissoc": self.kdissoc,
            "Jwact": self.Jwact,
            "Jwinact": self.Jwinact,
            "Wee1_total": self.Wee1_total,
            "kwact": self.kwact,
            "kwinact": self.kwinact,
            "Jiact": self.Jiact,
            "Jiinact": self.Jiinact,
            "kiact": self.kiact,
            "kiinact": self.kiinact,
            "kedeg": self.kedeg,
            "kxdeg": self.kxdeg,
            "kdact": self.kdact,
            "theta": self.theta,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.06, 1.02, 0.94, 3, 0, 0, 0, 0, 0.6, 0, 0, 0, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "ciliberto_petrus_tyson_sible_2003"
        self.curve_names = [
            "Cdk2_CycE",
            "Wee1_a",
            "PCdk2_CycE",
        ...
        self.state_names = ['Cdk2_CycE', 'Wee1_a', 'PCdk2_CycE', 'Xic', 'Cdk2_CycErem', 'Xic_Cdk2_CycE', 'PCdk2_CycErem', 'Xic_PCdk2_CycE', 'Kin_a', 'Deg_a', 'Xic_Cdk2_CycErem', 'Xic_PCdk2_CycErem', 'Xicrem']
        self.algebraic_names = ['pool', 'x', 'Cyc_total', 'Xic_total', 'phi', 'Heav']
        self.params = param
        self.T = T
        self.T_unit = T_unit
