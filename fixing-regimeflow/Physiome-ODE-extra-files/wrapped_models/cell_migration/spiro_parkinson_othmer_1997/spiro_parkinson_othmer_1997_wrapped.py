...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "spiro_parkinson_othmer_1997"
        self.curve_names = [
            "T2",
            "LT2",
            "T2R",
        ...
        self.state_names = ['T2', 'LT2', 'T2R', 'T3', 'Bp', 'T2p', 'Yp', 'LT3', 'T3R', 'T4', 'T3p', 'LT4', 'T4p', 'LT2p', 'T2pR', 'LT3p', 'T3pR', 'LT4p', 'LT2R', 'LT3R', 'LT2pR', 'LT3pR']
        self.algebraic_names = ['Vmax', 'Vmax_1', 'Vmax_2', 'Vmax_3', 'Vmax_4', 'Vmax_5', 'Vmax_6', 'Vmax_7', 'P']
        self.params = param
        self.T = T
        self.T_unit = T_unit
