...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[6000000, 0, 0, 300000, 5900, 100, 0, 0, 0, 1, 0, 100, 10000, 1000],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "proctor_soti_boys_gillespie_shanley_wilkinson_kirkwood_2005"
        self.curve_names = [
            "NatP",
            "MisP",
            "MCom",
        ...
        self.state_names = ['NatP', 'MisP', 'MCom', 'Hsp90', 'HCom', 'HSF1', 'DiH', 'TriH', 'HSE_TriH', 'HSE', 'AggP', 'ROS', 'ATP', 'ADP']
        self.algebraic_names = ['v2', 'v3', 'v21', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9', 'v7b', 'v10', 'v11', 'v12', 'v14', 'v13', 'v15', 'v16', 'v17', 'v18', 'v19']
        self.params = param
        self.T = T
        self.T_unit = T_unit
