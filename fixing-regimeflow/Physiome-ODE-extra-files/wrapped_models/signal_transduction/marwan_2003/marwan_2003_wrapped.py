...
class Parameters:
    def __init__(self):
        self.Ifr_sigma_fr_phi_fr = 0.1
        self.Ir_sigma_r_phi_r = 0.0
        self.kd = 0.1
        self.kia = 0.1
        self.kai = 0.8
        self.kx = 0.2
    ...
    def to_dict(self):
        return {
            "Ifr_sigma_fr_phi_fr": self.Ifr_sigma_fr_phi_fr,
            "Ir_sigma_r_phi_r": self.Ir_sigma_r_phi_r,
            "kd": self.kd,
            "kia": self.kia,
            "kai": self.kai,
            "kx": self.kx,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[10.0, 0.0, 6.0, 0.0, 200.0, 0.0, 0.9, 0.0, 50.0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "marwan_2003"
        self.curve_names = [
            "Pfr",
            "Pr",
            "Xi",
        ...
        self.state_names = ['Pfr', 'Pr', 'Xi', 'Xa', 'prepreS', 'preS', 'Ya', 'S', 'V']
    ...
    def _build_constants(self):
        ...
        # direct mapping
        c[0] = p.Ifr_sigma_fr_phi_fr
        c[1] = p.Ir_sigma_r_phi_r
        c[2] = p.kd
        c[3] = p.kia
        c[4] = p.kai
        c[5] = p.kx
