...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.012, 3.33E-4, 2E-5, 4.99E-4, 4.94E-3, 8.01E-5, 0.17, 0.339, 0.91, 0.0275, 0.0568, 0.0057, 25.2, 7.88E-7, 2.15E-4, 7.76E-3, 0.0798, 5.21E-3, 0.283, 0.014, 0.708, 2.14E-5, 1.07E-4, 1.1E-3, 1.1E-3, 8.15E-5, 1.36E-6, 2.27E-6, 8.46E-5],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "cui_kaandorp_2008"
        self.curve_names = [
            "BMK1",
            "MRNA",
            "NFATc",
        ...
        self.state_names = ['BMK1', 'MRNA', 'NFATc', 'NFATn', 'NFATpc', 'NFATpn', 'GSK3betac', 'GSK3betan', 'CaNc', 'CaNc_star', 'CaNn_star', 'CaNn', 'CaM', 'CaMCa', 'MCIP', 'MCIPp', 'MCIPpp', 'Comp1', 'Comp2', 'Comp3', 'P1433', 'MCIP_BMK1', 'MCIPp_CaNc_star', 'MCIPp_GSK3betac', 'MCIPpp_CaNc_star', 'NFATpc_CaNc_star', 'NFATc_GSK3betac', 'NFATpn_CaNn_star', 'NFATn_GSK3betan']
        self.algebraic_names = ['v1', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'v9', 'v10a', 'v10b', 'v10', 'v11a', 'v11b', 'v11', 'v16a', 'v12a', 'v16b', 'v12b', 'v16', 'v12', 'v17a', 'v13a', 'v17b', 'v13b', 'v17', 'v14a', 'v13', 'v18', 'v14b', 'v19', 'v14', 'v15a', 'v15b', 'v15']
        self.params = param
        self.T = T
        self.T_unit = T_unit
