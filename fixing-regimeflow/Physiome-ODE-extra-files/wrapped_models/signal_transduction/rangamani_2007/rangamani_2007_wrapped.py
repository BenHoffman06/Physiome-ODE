...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.616, 0, 100, 0, 150, 0, 100, 0, 100, 0, 100, 0, 0, 250, 0, 0, 0, 100, 0, 0, 80, 0, 0, 200, 0, 0, 0, 0, 0, 800, 0, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "rangamani_2007"
        self.curve_names = [
            "R_NOS2",
            "c1",
            "c2",
        ...
        self.state_names = ['R_NOS2', 'c1', 'c2', 'c3', 'c4', 'c5', 'c6', 'c7', 'c8', 'c9', 'c10', 'c11', 'c12', 'c13', 'c14', 'c15', 'c16', 'c17', 'c18', 'c19', 'c20', 'c21', 'c22', 'c23', 'c24', 'c25', 'c26', 'c27', 'c28', 'c29', 'c30', 'c31']
        self.algebraic_names = ['J1', 'v14', 'J2', 'deg_no', 'J3', 'J4', 'J5', 'J6', 'J7', 'J8', 'J9', 'J10', 'J11', 'J12', 'J13', 'J14', 'J15', 'J16', 'J17', 'J18', 'J19']
        self.params = param
        self.T = T
        self.T_unit = T_unit
