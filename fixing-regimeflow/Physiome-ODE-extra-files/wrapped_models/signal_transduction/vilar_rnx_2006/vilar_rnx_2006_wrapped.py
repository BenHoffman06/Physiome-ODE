...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[20.0, 20.0, 0.0, 0.0, 40.0, 0.0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "vilar_rnx_2006"
        self.curve_names = [
            "RI",
            "RII",
            "l_RI_RII",
        ...
        self.state_names = ['RI', 'RII', 'l_RI_RII', 'RI_endo', 'l_RI_RII_endo', 'RII_endo']
        self.algebraic_names = ['v2', 'v3', 'v4', 'v6', 'v7', 'v8', 'v9', 'v11', 'v12', 'v13', 'l', 'v1']
        self.params = param
        self.T = T
        self.T_unit = T_unit
