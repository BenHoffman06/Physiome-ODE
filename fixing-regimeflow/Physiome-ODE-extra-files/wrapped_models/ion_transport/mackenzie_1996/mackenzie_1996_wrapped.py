...
def createLegends():
    ...
    legend_constants[0] = "k0_12 in component parameters (per_M_per_second)"
    ...
    legend_constants[11] = "k0_65 in component parameters (per_M_per_second)"
    ...
    legend_algebraic[1] = "ks_12 in component rate_constants (per_M_per_second)"
    ...
    legend_algebraic[34] = "C_sum in component king_altman_states (per_second5)"
    legend_algebraic[35] = "C1 in component king_altman_states (umol)"
    legend_algebraic[36] = "C2 in component king_altman_states (umol)"
    legend_algebraic[37] = "C3 in component king_altman_states (umol)"
    legend_algebraic[38] = "C4 in component king_altman_states (umol)"
    legend_algebraic[39] = "C5 in component king_altman_states (umol)"
    legend_algebraic[40] = "C6 in component king_altman_states (umol)"
    legend_algebraic[19] = "I_NaGl_pSS in component NBC_current (uA)"
    legend_algebraic[42] = "I_NaGl_SS in component NBC_current (uA)"
    legend_algebraic[41] = "J_Na in component NBC_current (umol_per_second)"
    legend_algebraic[28] = "epsilon in component phenomonological_constants (per_second)"
    legend_algebraic[17] = "lambda in component phenomonological_constants (per_M2_per_second5)"
    legend_algebraic[20] = "chi in component phenomonological_constants (M)"
    legend_algebraic[26] = "alpha in component phenomonological_constants (M2)"
    legend_algebraic[23] = "beta in component phenomonological_constants (M)"
    legend_algebraic[21] = "gamma in component phenomonological_constants (M2_per_second)"
    ...
    legend_algebraic[29] = "Khalf_Na in component phenomonological_constants (M)"
...
def computeAlgebraic(constants, states, voi):
    ...
    algebraic[30] = (algebraic[26]+algebraic[20]*constants[26])/(algebraic[23]+constants[26])
    ...
    algebraic[33] = (2.00000*constants[22]*constants[30]*algebraic[28]*constants[26])/(algebraic[23]+constants[26])
    algebraic[34] = algebraic[16]+algebraic[18]+algebraic[22]+algebraic[24]+algebraic[27]+algebraic[31]
    algebraic[35] = (constants[30]*algebraic[16])/algebraic[34]
    algebraic[36] = (constants[30]*algebraic[18])/algebraic[34]
    algebraic[37] = (constants[30]*algebraic[22])/algebraic[34]
    algebraic[38] = (constants[30]*algebraic[24])/algebraic[34]
    algebraic[39] = (constants[30]*algebraic[27])/algebraic[34]
    algebraic[40] = (constants[30]*algebraic[31])/algebraic[34]
    algebraic[41] = (algebraic[7]*algebraic[36]-algebraic[12]*algebraic[39])+(algebraic[5]*algebraic[37]-algebraic[6]*algebraic[38])
    algebraic[42] = -constants[22]*(constants[20]*(algebraic[11]*algebraic[35]-algebraic[10]*algebraic[40])+(constants[20]+constants[21]*constants[19])*(algebraic[7]*algebraic[36]-algebraic[12]*algebraic[39])+(constants[20]+constants[21]*constants[19])*(algebraic[5]*algebraic[37]-algebraic[6]*algebraic[38]))
    return algebraic
...
class Parameters:
    def __init__(self):
        ...
        self.glucose_i = 0e-3
        self.glucose_o = 1e-3
        self.legend_constants_34 = 0.000100000
    ...
    def to_dict(self):
        return {
            ...
            "legend_constants_34": self.legend_constants_34,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-150e-3, 3.923e-9, 1.016e-7, 1.515e-8, 8.912e-10, 1.485e-8, 3.06798e-9],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "mackenzie_1996"
        self.curve_names = [
            "V",
            "C_1",
            "C_2",
        ...
        self.algebraic_names = ['mu', 'ks_12', 'k_52_temp', 'k_12', 'k_21', 'k_34', 'k_43', 'k_25', 'k_56', 'k_65', 'k_61', 'k_16', 'k_52', 'k0_54_temp', 'k_54', 'C_6', 'C1_sum', 'lambda', 'C2_sum', 'I_NaGl_pSS', 'chi', 'gamma', 'C3_sum', 'beta', 'C4_sum', 'phi', 'alpha', 'C5_sum', 'epsilon', 'Khalf_Na', 'Khalf_gluc', 'C6_sum', 'Imax_Na', 'Imax_gluc', 'C_sum', 'C1', 'C2', 'C3', 'C4', 'C5', 'C6', 'J_Na', 'I_NaGl_SS']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[27] = p.glucose_i
        c[28] = p.glucose_o
        c[34] = p.legend_constants_34

        # derived constants
        c[29] = (1.00000-c[14])-c[15]
        c[30] = (1.00000e+06*c[16])/c[17]
        c[31] = c[2]*c[28]
        c[32] = c[3]
        c[33] = c[6]
