...
class Parameters:
    def __init__(self):
        ...
        self.Na_i = 20e-3
        self.Na_o = 100e-3
        self.glucose_i = 10e-6
        self.glucose_o = 0e-3
        self.legend_constants_34 = 0.00000
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-50e-3, 1.505e-8, 7.3976e-8, 2.4603e-10, 3.4444e-10, 1.5338e-9, 8.484e-9],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "Parent_et_al_1992"
        self.curve_names = [
            "V",
            "C_1",
            "C_2",
