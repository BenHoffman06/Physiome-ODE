...
class Parameters:
    ...
    def to_dict(self):
        return {
            ...
            "omega_m_1": self.omega_m_1,
            "tau_h_max": self.tau_h_max,
            "theta_h": self.theta_h,
            "omega_h": self.omega_h,
            "g_leak": self.g_leak,
            "E_leak": self.E_leak,
            "g_tonic_e": self.g_tonic_e,
            "E_syn_e": self.E_syn_e,
        }
...
class Config:
    def __init__(
        ...
        self.model_name = "purvis_smith_koizumi_butera_2007_npc"
        self.curve_names = [
            "V",
            "n",
            "h",
        ]
        self.state_names = ['V', 'n', 'h']
        self.algebraic_names = ['m_infinity', 'n_infinity', 'h_infinity', 'i_Na', 'tau_n', 'tau_h', 'i_K', 'm_infinity_1', 'i_NaP', 'i_leak', 'i_tonic_e']
        self.params = param
        self.T = T
        self.T_unit = T_unit
