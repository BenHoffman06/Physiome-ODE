...
def createLegends():
    ...
    legend_constants[7] = "K in component E (dimensionless)"
...
def computeRates(voi, states, constants):
    ...
    rates[2] = (constants[5]*states[1])/((states[1]+constants[7])*states[2])-constants[6]*states[2]
    return(rates)
...
class Config:
    def __init__(
        ...
        self.model_name = "bonhoeffer_rembiszewski_ortiz_nixon_2000_a"
        self.curve_names = [
            "T",
            "I",
            "E",
        ]
        self.state_names = ['T', 'I', 'E']
