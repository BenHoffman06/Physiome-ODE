...
def createLegends():
    ...
    legend_states[2] = "y in component infected (dimensionless)"
    legend_constants[4] = "k in component virus (first_order_rate_constant)"
    legend_constants[5] = "u in component virus (first_order_rate_constant)"
    legend_rates[1] = "d/dt x in component uninfected (dimensionless)"
    legend_rates[2] = "d/dt y in component infected (dimensionless)"
...
def computeRates(voi, states, constants):
    ...
    rates[2] = constants[2]*states[1]*states[0]-constants[3]*states[2]
    rates[0] = constants[4]*states[2]-constants[5]*states[0]
    return(rates)
...
class Config:
    def __init__(
        ...
        self.model_name = "nowak_bangham_1996"
        self.curve_names = [
            "v",
            "x",
            "y",
        ]
        self.state_names = ['v', 'x', 'y']
