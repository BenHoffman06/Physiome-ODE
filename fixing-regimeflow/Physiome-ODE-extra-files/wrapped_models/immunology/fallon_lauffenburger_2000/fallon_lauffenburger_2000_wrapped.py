...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[1500, 10, 1, 300, 0.01, 1, 1, 2.5e8],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "fallon_lauffenburger_2000"
        self.curve_names = [
            "Rs",
            "L",
            "Cs",
        ...
        self.state_names = ['Rs', 'L', 'Cs', 'Ri', 'Li', 'Ci', 'Ld', 'Y']
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[10] = (c[1]/11.1000 if equal(c[9] , 1.00000) else c[1]/8.20000)
        c[11] = (c[1]*8.00000 if equal(c[9] , 1.00000) else c[1]*5.00000)
        c[12] = (c[11]/1000.00 if equal(c[9] , 1.00000) else c[11]/3000.00)
