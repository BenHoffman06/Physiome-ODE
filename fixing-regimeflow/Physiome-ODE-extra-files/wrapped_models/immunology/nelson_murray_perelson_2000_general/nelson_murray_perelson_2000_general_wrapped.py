...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[180.0, 134e3, 3.6, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "nelson_murray_perelson_2000_general"
        self.curve_names = [
            "T",
            "VI",
            "T_star",
        ...
        self.state_names = ['T', 'VI', 'T_star', 'VNI']
        self.algebraic_names = ['log_VI', 'virus_total', 'log_virus_total']
        self.params = param
        self.T = T
        self.T_unit = T_unit
