...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[2109.91, 3622.54, 25.0404, 39.8952],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "guyton_electrolytes_2008"
        self.curve_names = [
            "NAE",
            "KTOT",
            "VIC",
        ...
        self.state_names = ['NAE', 'KTOT', 'VIC', 'VTW']
        self.algebraic_names = ['KE', 'KI', 'CKI', 'VEC', 'CNA', 'CKE', 'CCD', 'VID']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[11] = (c[6]*c[3]-c[2])+c[7]*142.000
        c[12] = (c[0]-1.00000)*c[8]+1.00000
        c[13] = c[9]-c[4]
        c[14] = c[1]-c[5]
        c[15] = c[11]
        c[16] = c[13]
