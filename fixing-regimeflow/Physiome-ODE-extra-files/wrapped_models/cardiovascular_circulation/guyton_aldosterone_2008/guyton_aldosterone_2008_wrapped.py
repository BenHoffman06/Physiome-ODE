...
class Config:
    def __init__(
        ...
        self.model_name = "guyton_aldosterone_2008"
        self.curve_names = [
            "AMC",
        ]
        self.state_names = ['AMC']
        self.algebraic_names = ['AM1', 'AM', 'AMKT', 'AMNAT', 'AMK', 'AMNA']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[15] = (c[0]-1.00000)*c[2]+1.00000
        c[16] = (c[1]-3.30000)/1.00000
        c[17] = c[15]*0.909000*c[16]
        c[18] = (c[17]-1.00000)*c[3]+1.00000
        c[19] = (0.00000 if (c[18] < 0.00000) else c[18])
        c[20] = (c[5] if (c[5] > 0.00000) else c[19]+c[4])
