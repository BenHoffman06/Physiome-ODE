...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[1.0, 0.0, 0.859476, 1.0, 1.0, 1.00132, 1.00007, 3.00449, 216.243, 0.0, 279.945, 1.00163, 1.00237, 2.00439, 0.0101913, 0.00366525, 3.28246, 0.862514, 0.379883, 0.38131, 0.100043, 0.000980838, 39.8952, 2109.91, 3622.54, 25.0404, 1.0, 1.00269, 1.09071, 204.497, 48.0839, 1.02127, 1.01179, 1.1448, 72.2362, 0.0123238, 0.419998, 2.368e-07, 0.301963, 103.525, 0.0, 159.549, 0.0367573],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "Guyton_Model_1-0"
        self.curve_names = [
            "AMC",
            "ANX1",
            "ANC",
        ...
        self.state_names = ['AMC', 'ANX1', 'ANC', 'ADHC', 'ANPC', 'AU6', 'AU1', 'VP', 'PRP', 'VTS2', 'TSP', 'HPL', 'HPR', 'VRC', 'VV6', 'VV7', 'VVS1', 'VAS1', 'VLA1', 'VPA1', 'VRA1', 'TVD', 'VTW', 'NAE', 'KTOT', 'VIC', 'HMD1', 'AMM1T', 'AMM2', 'OVA', 'QOM1', 'AR1T', 'AR2T', 'AR3T', 'QO2T', 'VPF1', 'PPR1', 'O2VAD1', 'AHY', 'PAR1', 'RNAUG3', 'PLUR', 'DTKA']
        self.algebraic_names = ['AM1', 'AM', 'AMKT', 'AMK', 'AMNAT', 'AMNA', 'ANM', 'ANMAL', 'ANU1', 'ANU', 'ANUVN', 'ADHMV1', 'ADHMV', 'ADHMK1', 'ADHMK', 'ANPX1', 'ANPX', 'AU6C', 'AUT', 'AU', 'VVR', 'AUO', 'AUH', 'AUR', 'AOM', 'AUM', 'AVE', 'CPP', 'CPPD', 'DLP', 'PPC', 'VBD', 'VRA', 'VRE', 'PRA', 'ANPR2', 'PRA1', 'QRN', 'VPA', 'VPE', 'PPA', 'PP1T', 'PP1', 'CPA', 'RPA', 'VLA', 'VLE', 'PLA', 'ANPL', 'AULP', 'ANP', 'PL1', 'ANP1', 'RPV', 'RPT', 'PGL', 'QPO', 'PLA1', 'QLN', 'VVS', 'VVA', 'PR1', 'VAS', 'VAE', 'PA', 'PA1', 'AUB', 'ADHPA', 'A1B', 'ADHPR', 'AU6A', 'AUC', 'AUN', 'QLO1', 'PAG', 'PAM', 'FISFLO', 'AMK1', 'KE', 'KI', 'CKI', 'VEC', 'CNA', 'ADHNA1', 'CKE', 'CCD', 'OSMAL', 'ADHNA', 'HMD', 'VID', 'AMRBSC', 'ADH1', 'AUHR', 'AMRT', 'ADH', 'HDHR', 'AMR', 'HR', 'AMR1', 'AMM1', 'AMM', 'QOM', 'PMO', 'P2O', 'PDO', 'MMO', 'POE', 'POF', 'AR1', 'AR2', 'AR3', 'ARM1', 'ARM', 'QO2', 'POT', 'P1O', 'DHM', 'POD', 'MO2', 'POB', 'POA', 'POC', 'PCP', 'VPF', 'VTS', 'VTS1', 'VG', 'CPI', 'VIF', 'PTCPR', 'CHY', 'POSHYL', 'PTC', 'PTT', 'PGH', 'PIF', 'PLD1', 'PTS', 'PLD', 'VTL', 'DPL', 'PPI', 'PPR', 'CPN', 'POS', 'PFI', 'PPN', 'PLF', 'DFZ', 'DFP', 'PPO', 'PPZ', 'PPD', 'RSPDFC', 'O2VAD2', 'VB', 'HM1', 'HM', 'OSA', 'PP2', 'RVM', 'PA2', 'LVM', 'QLOT', 'QLO', 'HPEF', 'DLA', 'SVO', 'QRO', 'PO2ART', 'DPA', 'AUC2', 'O2VTST1', 'AUC3', 'O2VTST', 'AUTTL1', 'O2VTS2', 'AUTTL', 'VIE', 'DO2VAD', 'DAU', 'VIB', 'VIM', 'ANMSML', 'HM3', 'STH1', 'HM5', 'STH', 'HM7', 'AHZ1', 'RC1', 'AHCM', 'AHZ', 'RC2', 'ANMTH', 'AH7', 'RCD', 'AHTH1', 'ATRRFB', 'AHTH', 'R1', 'TVZ1', 'NNRAR', 'TVZ', 'RSM', 'ATRVFB', 'VVE1', 'VVE', 'PVS1', 'PVS', 'RVG', 'PGV', 'QVO', 'PGS', 'DRA', 'BFM', 'O2ARTM', 'PAR', 'AUMKT', 'AUMK', 'ANMAR1', 'ANMAR', 'AUMK2', 'ANMER', 'PLURC', 'DTNANG1', 'DTNANG', 'ANMKE1', 'ANMKE', 'RMO', 'PVO', 'OVS', 'MDFLW', 'RVS', 'BFN', 'PC', 'CN3', 'RV1', 'NNRVR', 'RSN', 'RNAUG2', 'RNAUG1', 'RNAUG1T', 'AAR1', 'AAR', 'AART', 'RNAUG4', 'EAR', 'EAR1', 'RR', 'RFN', 'GFN', 'GLPC', 'EFAFPR', 'EFAFPR1', 'GLP', 'APD', 'PFL', 'GFN1', 'PTFL', 'MDFLWT', 'DO2M', 'MDFLW3', 'PRCD', 'RBF', 'O2ARTN', 'GFR', 'RTSPPC1', 'ANGSCR', 'VTCPL', 'SYSFLO', 'DOB', 'POV', 'OSV', 'RTSPPC', 'ANX', 'ANPRT', 'VTC', 'DPC', 'QAO', 'DO2N1', 'O2UTIL', 'RCPRS', 'ANPR', 'VPD', 'DPP', 'DPI', 'DVS', 'DAS', 'RTP', 'DO2N', 'ALVENT', 'RABSPR', 'ANPR1', 'PO2ALV', 'RFAB1', 'O2DFS', 'RFAB', 'DOVA', 'RFABD1', 'RFABD', 'DTNAI', 'DTNARA1', 'DTNARA', 'DTKI', 'RFABK', 'MDFLK1', 'MDFLK', 'DTKSC', 'NODN1', 'NODN', 'NOD', 'KODN1', 'NED', 'KODN', 'KOD', 'DTURI', 'KTOTD', 'UROD', 'OSMOPN1', 'OSMOPN', 'OSMOP1T', 'OSMOP1', 'VUDN', 'VUD']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[206] = power(c[52], c[53])
        c[207] = (power(c[109], 0.500000))*5.00000
        c[208] = (80.0000 if (c[136] > 80.0000) else c[136])
        c[209] = c[136]-40.0000
