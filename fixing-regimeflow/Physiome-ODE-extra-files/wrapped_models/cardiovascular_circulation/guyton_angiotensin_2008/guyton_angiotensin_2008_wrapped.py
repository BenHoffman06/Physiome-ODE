...
class Config:
    def __init__(
        ...
        self.model_name = "guyton_angiotensin_2008"
        self.curve_names = [
            "ANX1",
            "ANC",
        ]
        self.state_names = ['ANX1', 'ANC']
        self.algebraic_names = ['ANPRT', 'ANM', 'ANPR', 'ANU1', 'ANPR1', 'ANU', 'ANUVN']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[14] = c[0]
        c[15] = (1.00000/(1.00000+(c[14]-1.00000)*72.0000) if (c[14] > 1.00000) else 10.0000-9.00000/(1.00000+(1.00000-c[14])*8.00000))
        c[16] = (c[15]-1.00000)*c[1]
