...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[103.525, 0.0, 159.549, 0.0367573],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "guyton_kidney_2008"
        self.curve_names = [
            "PAR1",
            "RNAUG3",
            "PLUR",
        ...
        self.state_names = ['PAR1', 'RNAUG3', 'PLUR', 'DTKA']
        self.algebraic_names = ['PAR', 'PLURC', 'MDFLW', 'RNAUG2', 'RNAUG1', 'RNAUG1T', 'AAR1', 'AAR', 'AART', 'RNAUG4', 'EAR', 'EAR1', 'RR', 'RFN', 'GFN', 'GLPC', 'EFAFPR', 'EFAFPR1', 'GLP', 'APD', 'PFL', 'GFN1', 'PTFL', 'MDFLWT', 'RBF', 'GFR', 'RTSPPC1', 'RTSPPC', 'RCPRS', 'RABSPR', 'RFAB1', 'RFAB', 'RFABD1', 'RFABD', 'DTNAI', 'DTNARA1', 'DTNARA', 'DTKI', 'RFABK', 'MDFLK1', 'MDFLK', 'DTKSC', 'NODN1', 'NODN', 'KODN1', 'NOD', 'KODN', 'DTURI', 'KOD', 'UROD', 'OSMOPN1', 'OSMOPN', 'OSMOP1T', 'OSMOP1', 'VUDN', 'VUD']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[62] = (c[5]-1.00000)*c[23]+1.00000
        c[63] = (0.800000 if (c[62] < 0.800000) else c[62])
        c[64] = (c[3]-1.00000)*c[24]+1.00000
        c[65] = (c[25] if (c[64] < c[25]) else c[64])
        c[66] = (c[63]-1.00000)*c[29]+1.00000
        c[67] = (c[3]-1.00000)*c[30]+1.00000
        c[68] = ((c[3]-1.00000)*c[54]+1.00000)*0.100000
        c[69] = (0.00000 if (c[68] < 0.00000) else c[68])
        c[70] = (c[3]-1.00000)*c[57]+1.00000
        c[71] = (c[58] if (c[70] < c[58]) else c[70])
