...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[3.28246, 0.862514, 0.379883, 0.38131, 0.100043],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "guyton_circulatory_dynamics_2008"
        self.curve_names = [
            "VVS1",
            "VAS1",
            "VLA1",
        ...
        self.state_names = ['VVS1', 'VAS1', 'VLA1', 'VPA1', 'VRA1']
        self.algebraic_names = ['VBD', 'VRA', 'VRE', 'PRA', 'PRA1', 'QRN', 'VPA', 'VPE', 'PPA', 'PP2', 'RVM', 'PP1T', 'PP1', 'CPA', 'RPA', 'VLA', 'VLE', 'PLA', 'PL1', 'RPV', 'RPT', 'PGL', 'QPO', 'PLA1', 'QLN', 'VVS', 'VVE1', 'VVE', 'PVS1', 'PVS', 'PR1', 'RVG', 'PGV', 'QVO', 'VAS', 'VAE', 'PA', 'PA2', 'LVM', 'QLOT', 'QLO1', 'QLO', 'HPEF', 'DLA', 'PAG', 'QRO', 'PAM', 'DRA', 'DPA', 'R1', 'NNRAR', 'PGS', 'RSM', 'RSN', 'BFM', 'BFN', 'FISFLO', 'SYSFLO', 'QAO', 'DVS', 'DAS', 'RTP']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[40] = (c[2]-1.00000)*c[29]
        c[41] = ((c[17]-17.0000)*c[32]+17.0000)*c[33]
        c[42] = c[34]/c[41]
        c[43] = c[10]*c[42]*c[19]*c[3]
        c[44] = c[43]*1.79000
