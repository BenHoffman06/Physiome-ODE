...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[3.00449, 216.243, 0.0, 279.945],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "guyton_capillary_dynamics_2008"
        self.curve_names = [
            "VP",
            "PRP",
            "VTS2",
        ...
        self.state_names = ['VP', 'PRP', 'VTS2', 'TSP']
        self.algebraic_names = ['CPP', 'CPPD', 'DLP', 'PPC', 'VTS', 'VTS1', 'VG', 'CPI', 'VIF', 'DPC', 'PTCPR', 'CHY', 'POSHYL', 'PTC', 'PTT', 'PGH', 'VTC', 'PIF', 'PLD1', 'PTS', 'PLD', 'VTL', 'VPD', 'DPL', 'DPP', 'DPI']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[24] = c[2]*1.70000*c[5]+c[6]
        c[25] = (0.00000 if (c[24]-c[13] < 0.00000) else c[24]-c[13])
        c[26] = power(c[25]*c[14], c[15])
