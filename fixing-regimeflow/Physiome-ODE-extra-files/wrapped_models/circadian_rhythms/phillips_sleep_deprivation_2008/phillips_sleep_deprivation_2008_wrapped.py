...
class Parameters:
    def __init__(self):
        self.tau_v = 10.0
        self.v_vm = -2.1
        self.awake_start = 167.04
        self.awake_end = 240.0
        self.Qmax = 100.0
        self.theta = 10.0
        self.sigma = 3.0
        self.tau_m = 10.0
        self.v_mv = -1.8
        self.A = 1.3
        self.awake_start_1 = 160.0
        self.awake_end_1 = 240.0
        self.chi = 45.0
        self.mu = 4.4
        self.c0 = 4.5
        self.alpha = 0
    ...
    def to_dict(self):
        return {
            "tau_v": self.tau_v,
            "v_vm": self.v_vm,
            "awake_start": self.awake_start,
            "awake_end": self.awake_end,
            "Qmax": self.Qmax,
            "theta": self.theta,
            "sigma": self.sigma,
            "tau_m": self.tau_m,
            "v_mv": self.v_mv,
            "A": self.A,
            "awake_start_1": self.awake_start_1,
            "awake_end_1": self.awake_end_1,
            "chi": self.chi,
            "mu": self.mu,
            "c0": self.c0,
            "alpha": self.alpha,
...
class Config:
    def __init__(
        ...
        self.model_name = "phillips_sleep_deprivation_2008"
        self.curve_names = [
            "Vv",
            "Vm",
            "H",
