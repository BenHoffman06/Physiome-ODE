...
def createLegends():
    ...
    legend_algebraic[9] = "l in component length (um)"
    legend_algebraic[5] = "F_muscle in component force (mN)"
    legend_algebraic[11] = "flag in component isotonic (dimensionless)"
    legend_constants[17] = "F_afterload in component isotonic (mN)"
    legend_algebraic[13] = "isotonic_mode in component isotonic (dimensionless)"
    legend_constants[18] = "l_0 in component isotonic (um)"
    legend_constants[19] = "S_0 in component parameters_izakov_et_al_1991 (um)"
    legend_algebraic[0] = "q_v in component parameters_izakov_et_al_1991 (per_millisecond)"
    ...
    legend_constants[24] = "v_star in component parameters_izakov_et_al_1991 (um_per_msec)"
    legend_constants[50] = "v_1 in component parameters_izakov_et_al_1991 (um_per_msec)"
    legend_constants[25] = "alpha_G in component parameters_izakov_et_al_1991 (dimensionless)"
    legend_constants[26] = "a_on in component parameters_izakov_et_al_1991 (per_millisecond)"
    ...
    legend_algebraic[31] = "F_CE in component force (mN)"
    legend_algebraic[4] = "F_XSE in component force (mN)"
    ...
    legend_algebraic[17] = "k_P_vis in component CE_velocity (mN_msec_per_um)"
    legend_algebraic[20] = "k_S_vis in component PE_velocity (mN_msec_per_um)"
    ...
    legend_algebraic[27] = "K_chi in component crossbridge_kinetics (per_millisecond)"
    ...
    legend_algebraic[25] = "k_p_v in component crossbridge_kinetics (per_millisecond)"
    legend_algebraic[26] = "k_m_v in component crossbridge_kinetics (per_millisecond)"
    ...
    legend_constants[31] = "v_0 in component crossbridge_kinetics (um_per_msec)"
    legend_constants[32] = "q_star in component crossbridge_kinetics (per_millisecond)"
    legend_algebraic[3] = "dl_1_dt in component length (um_per_msec)"
    legend_algebraic[22] = "dl_2_dt in component length (um_per_msec)"
    legend_algebraic[23] = "dl_3_dt in component length (um_per_msec)"
    legend_algebraic[18] = "phi_chi_2 in component CE_velocity (um_per_msec)"
    legend_algebraic[33] = "phi_chi in component CE_velocity (um_per_msec2)"
    legend_algebraic[32] = "p_prime_v in component average_crossbridge_force (msec_per_um)"
    legend_constants[33] = "alpha_P_lengthening in component CE_velocity (per_um)"
    legend_constants[34] = "beta_P_lengthening in component CE_velocity (mN_msec_per_um)"
    legend_constants[35] = "alpha_P_shortening in component CE_velocity (per_um)"
    legend_constants[36] = "beta_P_shortening in component CE_velocity (mN_msec_per_um)"
    legend_algebraic[15] = "alp_p in component CE_velocity (per_um)"
    legend_constants[37] = "alpha_S_lengthening in component PE_velocity (per_um)"
    legend_constants[38] = "beta_S_lengthening in component PE_velocity (mN_msec_per_um)"
    legend_constants[39] = "alpha_S_shortening in component PE_velocity (per_um)"
    legend_constants[40] = "beta_S_shortening in component PE_velocity (mN_msec_per_um)"
    legend_algebraic[19] = "alp_s in component PE_velocity (per_um)"
    legend_constants[53] = "gamma in component average_crossbridge_force (dimensionless)"
    legend_constants[51] = "case_1 in component average_crossbridge_force (msec_per_um)"
    legend_algebraic[28] = "case_2 in component average_crossbridge_force (msec_per_um)"
    legend_constants[52] = "case_3 in component average_crossbridge_force (msec_per_um)"
    legend_algebraic[29] = "case_4 in component average_crossbridge_force (msec_per_um)"
    ...
    legend_constants[43] = "b_on in component calcium_handling (per_millisecond)"
    legend_constants[44] = "b_off in component calcium_handling (per_millisecond)"
    legend_constants[45] = "a_c in component calcium_handling (per_millisecond2)"
    legend_constants[46] = "r_Ca in component calcium_handling (per_millisecond)"
    legend_constants[47] = "q_Ca in component calcium_handling (dimensionless)"
    legend_constants[48] = "t_d in component calcium_handling (millisecond)"
...
def computeRates(voi, states, constants):
    ...
    algebraic[11] = custom_piecewise([greater_equal(algebraic[9] , constants[18]) & less(voi , 150.000), 0.00000 , True, 1.00000])
...
class Parameters:
    def __init__(self):
        ...
        self.beta_P_lengthening = 1.5
        self.alpha_P_shortening = 16
        self.beta_P_shortening = 1.5
        self.alpha_S_lengthening = 39
        self.beta_S_lengthening = 8
        self.alpha_S_shortening = 46
        self.beta_S_shortening = 6
        self.A_tot = 1
        self.B_tot = 0.4
        self.b_on = 2.6
        self.b_off = 0.182
...
class Config:
    def __init__(
        ...
        self.model_name = "katsnelson_2004a"
        self.curve_names = [
            "v",
            "N",
            "w",
