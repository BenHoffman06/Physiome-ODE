...
class Parameters:
    ...
    def to_dict(self):
        return {
            "kM_plus": self.kM_plus,
            "kM_minus": self.kM_minus,
            "CaMtotal": self.CaMtotal,
            "kN_plus": self.kN_plus,
            "kN_minus": self.kN_minus,
            "CaNtotal": self.CaNtotal,
            "d": self.d,
            "f": self.f,
            "lamda": self.lamda,
            "N": self.N,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.0, 0.0, 1.0E-8, 0.0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "cui_kaandorp_2006"
        self.curve_names = [
            "m",
            "x",
            "z",
        ...
        self.state_names = ['m', 'x', 'z', 'h']
        self.algebraic_names = ['dmdt', 'dzdt', 'y', 'phi', 'psi', 'dxdt']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[21] = power(10.0000, -(c[9]/2.00000))
