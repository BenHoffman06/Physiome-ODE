...
def initConsts():
    ...
    constants[10] = 4
    constants[11] = 140
    states[1] = 138.49601832864
    states[2] = 5.68929064089788
    constants[12] = 2
    states[3] = 5.60867201979414e-6
    constants[13] = 10
    constants[14] = 0.5
    constants[15] = 0.0028
    constants[16] = 0.0017
    states[4] = 9.88715446781661e-6
    states[5] = 2.15138346929839e-7
    constants[17] = 0.0016
    states[6] = 6.72192033116639e-7
    constants[18] = 0.5
    states[7] = 0.00157541794600382
    states[8] = 0.99465397024286
    constants[19] = 1e-5
    constants[20] = 0
    constants[21] = 0.0027
    constants[22] = 0.0006
    ...
    constants[24] = 0.002
    constants[25] = 0.01
    states[9] = 2.15623822848619e-7
    states[10] = 2.27643784381792e-8
    constants[26] = 0.01
    constants[27] = 0.001
    constants[28] = 0.7
    constants[29] = 3
    states[11] = 4.03082807230434e-9
    constants[30] = 0.3
    constants[31] = 0.0001
    constants[32] = 0.00025
    constants[33] = 0.005
    constants[34] = 0
    states[12] = 0.999870016703514
    states[13] = 1.8398417043009e-8
    constants[35] = 0.7
    constants[36] = 1
    constants[37] = 40
    constants[38] = 0.0005
    ...
    constants[46] = 0.4
    constants[47] = 0.03
    states[14] = 0.187470810108547
    states[15] = 0.185609773872992
    constants[48] = 0.05
    constants[49] = 250
    constants[50] = 0.0005
    constants[51] = 0.01
    states[16] = 0.000183030061767109
    states[17] = 0.0109931117325847
    states[18] = 0.000221858224298955
    states[19] = 0.00013982468565579
    constants[52] = 0.02
    constants[53] = 0.05
    constants[54] = 100000
    constants[55] = 50
...
class Parameters:
    def __init__(self):
        ...
        self.alpha_up = 0.4
        self.beta_up = 0.03
        self.K_leak_rate = 0.05
        self.K_m_rel = 250
        self.K_m_Ca_cyt = 0.0005
        self.K_m_Ca_ds = 0.01
        self.Calmod = 0.02
        self.Trop = 0.05
    ...
    def to_dict(self):
        return {
            ...
            "P_CaK": self.P_CaK,
            "P_CaNa": self.P_CaNa,
            "KCaChoff": self.KCaChoff,
            "Kmdsinact": self.Kmdsinact,
            "FrICa": self.FrICa,
            ...
            "K_m_Ca_cyt": self.K_m_Ca_cyt,
            "K_m_Ca_ds": self.K_m_Ca_ds,
            "Calmod": self.Calmod,
            "Trop": self.Trop,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-93.0550060340878, 138.49601832864, 5.68929064089788, 5.60867201979414e-6, 9.88715446781661e-6, 2.15138346929839e-7, 6.72192033116639e-7, 0.00157541794600382, 0.99465397024286, 2.15623822848619e-7, 2.27643784381792e-8, 4.03082807230434e-9, 0.999870016703514, 1.8398417043009e-8, 0.187470810108547, 0.185609773872992, 0.000183030061767109, 0.0109931117325847, 0.000221858224298955, 0.00013982468565579],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "noble_noble_2001"
        self.curve_names = [
            "V",
            "K_i",
            "Na_i",
        ...
        self.state_names = ['V', 'K_i', 'Na_i', 'Ca_i', 'xr1', 'xr2', 'xs', 'm', 'h', 'Ca_ds', 'd', 'f', 's', 'r', 'Ca_up', 'Ca_rel', 'ActFrac', 'ProdFrac', 'Ca_Calmod', 'Ca_Trop']
        self.algebraic_names = ['alpha_xr1', 'alpha_xr2', 'alpha_xs', 'E0_m', 'alpha_h', 'E0_d', 'i_Stim', 'alpha_s', 'VoltDep', 'beta_xr1', 'beta_xr2', 'beta_xs', 'alpha_m', 'beta_h', 'alpha_d', 'E_Na', 'beta_s', 'CaiReg', 'beta_m', 'beta_d', 'E_K', 'CadsReg', 'E_Ks', 'RegBindSite', 'E_Ca', 'ActRate', 'E_mh', 'InactRate', 'i_K1', 'SpeedRel', 'i_Kr', 'PrecFrac', 'i_Ks', 'i_Na', 'i_p_Na', 'i_b_Na', 'E0_f', 'alpha_f', 'beta_f', 'CaChoffcyt', 'CaChoncyt', 'i_Ca_L_Ca_cyt', 'i_Ca_L_K_cyt', 'i_Ca_L_Na_cyt', 'CaChoffds', 'CaChonds', 'i_Ca_L_Ca_ds', 'i_Ca_L_K_ds', 'i_Ca_L_Na_ds', 'i_Ca_L', 'i_b_Ca', 'i_to', 'i_NaK', 'i_NaCa_cyt', 'i_NaCa_ds', 'i_NaCa', 'K_2', 'i_up', 'i_trans', 'i_rel']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[65] = (3.14159*(power(c[58]/1000.00, 2.00000))*c[59])/1000.00
        c[66] = (c[43]*c[44])/c[45]
        c[67] = ((1.00000-c[62])-c[63])-c[61]
        c[68] = c[65]*c[67]
