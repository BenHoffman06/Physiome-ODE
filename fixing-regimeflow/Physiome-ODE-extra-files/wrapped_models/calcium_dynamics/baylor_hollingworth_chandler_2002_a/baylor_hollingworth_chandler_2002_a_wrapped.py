...
def createLegends():
    ...
    legend_states[1] = "ATP in component ATP (micromolar)"
    legend_states[2] = "CaATP in component CaATP (micromolar)"
    legend_rates[0] = "d/dt Ca in component Ca (micromolar)"
    legend_rates[1] = "d/dt ATP in component ATP (micromolar)"
    legend_rates[2] = "d/dt CaATP in component CaATP (micromolar)"
...
class Config:
    def __init__(
        ...
        self.model_name = "baylor_hollingworth_chandler_2002_a"
        self.curve_names = [
            "Ca",
            "ATP",
            "CaATP",
        ]
        self.state_names = ['Ca', 'ATP', 'CaATP']
