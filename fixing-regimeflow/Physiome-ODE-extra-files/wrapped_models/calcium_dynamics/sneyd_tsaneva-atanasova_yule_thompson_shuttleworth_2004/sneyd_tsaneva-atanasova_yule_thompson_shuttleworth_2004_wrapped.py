...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.01, 0.01, 0.16, 0.01, 0.16, 0.16, 0.16, 0.16],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "sneyd_tsaneva-atanasova_yule_thompson_shuttleworth_2004"
        self.curve_names = [
            "c",
            "ce",
            "A",
        ...
        self.state_names = ['c', 'ce', 'A', 'O', 'R', 'I_1', 'S', 'I_2']
        self.algebraic_names = ['J_IPR', 'phi_1', 'J_serca', 'phi_2', 'J_pm', 'phi_2_', 'phi_3', 'phi_4', 'phi_4_', 'phi_5']
        self.params = param
        self.T = T
        self.T_unit = T_unit
