...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-61, 0.0005, 0.12, 0.11, 60],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "mears_sheppard_atwater_rojas_bertram_sherman_1997"
        self.curve_names = [
            "V",
            "n",
            "jm",
        ...
        self.algebraic_names = ['n_infinity', 'i_K', 'jm_infinity', 'tau_n', 'i_K_ATP', 'tau_j', 'm_f_infinity', 'i_Ca_f', 'm_s_infinity', 'i_Ca_s', 'i_Ca', 'i_K_Ca', 'J_er_p', 'r_infinity', 'a_infinity', 'i_CRAC', 'h_infinity', 'i_leak', 'O', 'J_er_leak', 'J_er_IP3', 'J_er_tot', 'Jmp', 'J_mem_tot']
        self.params = param
        self.T = T
        self.T_unit = T_unit
