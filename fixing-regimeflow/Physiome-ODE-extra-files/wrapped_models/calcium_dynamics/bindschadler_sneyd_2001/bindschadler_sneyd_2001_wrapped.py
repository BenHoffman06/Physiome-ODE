...
class Config:
    def __init__(
        ...
        self.model_name = "bindschadler_sneyd_2001"
        self.curve_names = [
            "h1",
            "h2",
            "c1",
        ...
        self.state_names = ['h1', 'h2', 'c1', 'c2']
        self.algebraic_names = ['phi1_c1', 'phi_1_c1', 'phi2_c1', 'phi1_c2', 'phi3_c1', 'phi_1_c2', 'phi2_c2', 'j_pump_c1', 'phi3_c2', 'j_pump_c2', 'j_receptor_c1', 'j_receptor_c2', 'j_diffusion']
        self.params = param
        self.T = T
        self.T_unit = T_unit
