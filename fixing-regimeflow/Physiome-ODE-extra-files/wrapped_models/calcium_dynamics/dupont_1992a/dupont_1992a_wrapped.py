...
def createLegends():
    ...
    legend_constants[12] = "vP in component phosphorylation (micromolar_min)"
    legend_algebraic[1] = "vK in component kinase_reaction (micromolar_min)"
    legend_constants[13] = "K1 in component phosphorylation (dimensionless)"
    legend_constants[14] = "K2 in component phosphorylation (dimensionless)"
    legend_constants[15] = "WT in component phosphorylation (micromolar)"
    legend_states[2] = "Wstar in component phosphorylation (dimensionless)"
    legend_constants[16] = "vMK in component kinase_reaction (micromolar_min)"
    legend_constants[17] = "Ka in component kinase_reaction (micromolar)"
    legend_constants[18] = "q in component kinase_reaction (dimensionless)"
...
def computeRates(voi, states, constants):
    ...
    algebraic[1] = constants[16]*((power(states[1], constants[18]))/(power(constants[17], constants[18])+power(states[1], constants[18])))
