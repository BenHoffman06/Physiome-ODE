...
class Parameters:
    def __init__(self):
        ...
        self.g_Na_Centre = 0
        self.g_Na_Periphery = 1.2e-6
        self.Na_o = 140
        self.g_Ca_L_Centre = 0.0058
        self.g_Ca_L_Periphery = 0.0659
        self.E_Ca_L = 46.4
        self.g_Ca_T_Centre = 0.0043
        self.g_Ca_T_Periphery = 0.0139
        self.E_Ca_T = 45
        self.g_to_Centre = 0.00491
        self.g_to_Periphery = 0.03649
        self.g_sus_Centre = 6.65e-5
        self.g_sus_Periphery = 0.0114
        self.g_K_r_Centre = 0.000797
        self.g_K_r_Periphery = 0.016
        self.tau_P_i = 0.002
        self.g_K_s_Centre = 0.000518
        self.g_K_s_Periphery = 0.0104
        self.g_f_Na_Centre = 0.000548
        self.g_f_Na_Periphery = 0.0069
        self.g_f_K_Centre = 0.000548
        self.g_f_K_Periphery = 0.0069
        self.g_b_Na_Centre = 5.8e-5
        self.g_b_Na_Periphery = 0.000189
        self.g_b_K_Centre = 2.52e-5
        self.g_b_K_Periphery = 8.19e-5
        self.g_b_Ca_Centre = 1.32e-5
        self.g_b_Ca_Periphery = 4.3e-5
        self.k_NaCa_Centre = 2.7e-6
        self.k_NaCa_Periphery = 8.8e-6
        self.d_NaCa = 0.0001
        self.gamma_NaCa = 0.5
        self.Na_i = 8
        self.Ca_i = 0.0001
        ...
        self.K_m_Na = 5.64
        self.K_m_K = 0.621
        self.i_p_max_Centre = 0.0478
        self.i_p_max_Periphery = 0.16
        self.K_o = 5.4
        self.K_i = 140
        self.g_st = 0.00214
        self.i_Ca_P_max = 0.24
        self.J_Ca_P_max = 0.00000000096
        self.J_Ca_u_max = 0.00000000096
        self.B_d = 0.4
        self.B_s = 0.2
        self.Vol_c = 8.0e-12
        self.K_m_b = 0.002
        ...
        self.f_r = 0.3
        self.f_u = 0.06
        self.alpha_ds = 3300.0
        self.alpha_fR = 6670.0
        self.alpha_1 = 0.172
        self.alpha_r = 333.5
        self.alpha_ur = 533.6
        self.beta_fR = 2.0
    ...
    def to_dict(self):
        return {
            ...
            "g_Na_Centre": self.g_Na_Centre,
            "g_Na_Periphery": self.g_Na_Periphery,
            "Na_o": self.Na_o,
            "g_Ca_L_Centre": self.g_Ca_L_Centre,
            "g_Ca_L_Periphery": self.g_Ca_L_Periphery,
            "E_Ca_L": self.E_Ca_L,
            "g_Ca_T_Centre": self.g_Ca_T_Centre,
            "g_Ca_T_Periphery": self.g_Ca_T_Periphery,
            "E_Ca_T": self.E_Ca_T,
            "g_to_Centre": self.g_to_Centre,
            "g_to_Periphery": self.g_to_Periphery,
            "g_sus_Centre": self.g_sus_Centre,
            "g_sus_Periphery": self.g_sus_Periphery,
            "g_K_r_Centre": self.g_K_r_Centre,
            "g_K_r_Periphery": self.g_K_r_Periphery,
            "tau_P_i": self.tau_P_i,
            "g_K_s_Centre": self.g_K_s_Centre,
            "g_K_s_Periphery": self.g_K_s_Periphery,
            "g_f_Na_Centre": self.g_f_Na_Centre,
            "g_f_Na_Periphery": self.g_f_Na_Periphery,
            "g_f_K_Centre": self.g_f_K_Centre,
            "g_f_K_Periphery": self.g_f_K_Periphery,
            "g_b_Na_Centre": self.g_b_Na_Centre,
            "g_b_Na_Periphery": self.g_b_Na_Periphery,
            "g_b_K_Centre": self.g_b_K_Centre,
            "g_b_K_Periphery": self.g_b_K_Periphery,
            "g_b_Ca_Centre": self.g_b_Ca_Centre,
            "g_b_Ca_Periphery": self.g_b_Ca_Periphery,
            "k_NaCa_Centre": self.k_NaCa_Centre,
            "k_NaCa_Periphery": self.k_NaCa_Periphery,
            "d_NaCa": self.d_NaCa,
            ...
            "K_m_Na": self.K_m_Na,
            "K_m_K": self.K_m_K,
            "i_p_max_Centre": self.i_p_max_Centre,
            "i_p_max_Periphery": self.i_p_max_Periphery,
            "K_o": self.K_o,
            "K_i": self.K_i,
            "g_st": self.g_st,
            "i_Ca_P_max": self.i_Ca_P_max,
            "J_Ca_P_max": self.J_Ca_P_max,
            "J_Ca_u_max": self.J_Ca_u_max,
            "B_d": self.B_d,
            "B_s": self.B_s,
            "Vol_c": self.Vol_c,
            "K_m_b": self.K_m_b,
            ...
            "alpha_fR": self.alpha_fR,
            "alpha_1": self.alpha_1,
            "alpha_r": self.alpha_r,
            "alpha_ur": self.alpha_ur,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-39.013558536, 0.092361701692, 0.015905380261, 0.01445216109, 0.04804900895, 0.48779845203, 0.42074047435, 0.038968420558, 0.29760539675, 0.064402950262, 0.13034201158, 0.46960956028, 0.87993375273, 0.082293827208, 0.03889291759, 0.230, 0.283, 0.001544, 0.05487, 6.983, 4.909, 0.188],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "boyett_zhang_garny_holden_2001"
        self.curve_names = [
            "V",
            "m",
            "h1",
        ...
        self.state_names = ['V', 'm', 'h1', 'h2', 'd_L', 'f_L', 'd_T', 'f_T', 'q', 'r', 'P_af', 'P_as', 'P_i', 'xs', 'y', 'd_s', 'f_s', 'Ca_d', 'Ca_s', 'Ca_u', 'Ca_r', 'f_R']
        self.algebraic_names = ['F_Na', 'i_st', 'm_infinity', 'h1_infinity', 'alpha_d_L', 'alpha_f_L', 'alpha_d_T', 'alpha_f_T', 'q_infinity', 'r_infinity', 'P_af_infinity', 'P_i_infinity', 'alpha_xs', 'alpha_y', 'alpha_d_s', 'alpha_f_s', 'J_Ca_P', 'h', 'tau_m', 'h2_infinity', 'tau_h1', 'beta_d_L', 'beta_f_L', 'beta_d_T', 'beta_f_T', 'tau_q', 'tau_r', 'tau_P_af', 'P_as_infinity', 'beta_xs', 'beta_y', 'beta_d_s', 'beta_f_s', 'i_Na', 'tau_h2', 'tau_d_L', 'tau_f_L', 'tau_d_T', 'tau_f_T', 'tau_P_as', 'tau_d_s', 'tau_f_s', 'i_Ca_L', 'd_L_infinity', 'f_L_infinity', 'd_T_infinity', 'f_T_infinity', 'd_s_infinity', 'f_s_infinity', 'i_Ca_T', 'i_to', 'i_sus', 'P_a', 'i_K_r', 'i_K_s', 'i_f_Na', 'i_f_K', 'i_b_Na', 'i_b_K', 'i_b_Ca', 'i_NaCa', 'i_p', 'U_d', 'i_Ca_P', 'J_Ca_ds', 'J_Ca_r', 'U_s', 'J_Ca_u', 'J_Ca_ur', 'J_Ca_1', 'i_Ca']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[5] = p.CmPeriphery
        c[6] = p.g_Na_Centre
        c[7] = p.g_Na_Periphery
        c[8] = p.Na_o
        c[9] = p.g_Ca_L_Centre
        c[10] = p.g_Ca_L_Periphery
        c[11] = p.E_Ca_L
        c[12] = p.g_Ca_T_Centre
        c[13] = p.g_Ca_T_Periphery
        c[14] = p.E_Ca_T
        c[15] = p.g_to_Centre
        c[16] = p.g_to_Periphery
        c[17] = p.g_sus_Centre
        c[18] = p.g_sus_Periphery
        c[19] = p.g_K_r_Centre
        c[20] = p.g_K_r_Periphery
        c[21] = p.tau_P_i
        c[22] = p.g_K_s_Centre
        c[23] = p.g_K_s_Periphery
        c[24] = p.g_f_Na_Centre
        c[25] = p.g_f_Na_Periphery
        c[26] = p.g_f_K_Centre
        c[27] = p.g_f_K_Periphery
        c[28] = p.g_b_Na_Centre
        c[29] = p.g_b_Na_Periphery
        c[30] = p.g_b_K_Centre
        c[31] = p.g_b_K_Periphery
        c[32] = p.g_b_Ca_Centre
        c[33] = p.g_b_Ca_Periphery
        c[34] = p.k_NaCa_Centre
        c[35] = p.k_NaCa_Periphery
        c[36] = p.d_NaCa
        c[37] = p.gamma_NaCa
        c[38] = p.Na_i
        c[39] = p.Ca_i
        ...
        c[41] = p.K_m_Na
        c[42] = p.K_m_K
        c[43] = p.i_p_max_Centre
        c[44] = p.i_p_max_Periphery
        c[45] = p.K_o
        c[46] = p.K_i
        c[47] = p.g_st
        c[48] = p.i_Ca_P_max
        ...
        # derived constants
        c[66] = (1.07000*(3.00000*c[0]-0.100000))/(3.00000*(1.00000+0.774500*exp(-(3.00000*c[0]-2.05000)/0.295000)))
        c[67] = ((c[1]*c[2])/c[3])*log(c[8]/c[38])
        c[68] = ((c[1]*c[2])/c[3])*log(c[45]/c[46])
        c[69] = ((c[1]*c[2])/c[3])*log((c[45]+0.120000*c[8])/(c[46]+0.120000*c[38]))
        c[70] = ((c[1]*c[2])/(2.00000*c[3]))*log(c[40]/c[39])
        c[71] = c[4]+c[66]*(c[5]-c[4])
        c[72] = c[6]+c[66]*(c[7]-c[6])
        c[73] = c[9]+c[66]*(c[10]-c[9])
        c[74] = c[12]+c[66]*(c[13]-c[12])
        c[75] = c[15]+c[66]*(c[16]-c[15])
        c[76] = c[17]+c[66]*(c[18]-c[17])
        c[77] = c[19]+c[66]*(c[20]-c[19])
        c[78] = c[22]+c[66]*(c[23]-c[22])
        c[79] = c[24]+c[66]*(c[25]-c[24])
        c[80] = c[26]+c[66]*(c[27]-c[26])
        c[81] = c[28]+c[66]*(c[29]-c[28])
        c[82] = c[30]+c[66]*(c[31]-c[30])
        c[83] = c[32]+c[66]*(c[33]-c[32])
        c[84] = c[34]+c[66]*(c[35]-c[34])
        c[85] = c[43]+c[66]*(c[44]-c[43])
        c[86] = c[59]*c[53]
        c[87] = c[58]*c[53]
        c[88] = c[57]*c[53]
        c[89] = c[53]-(c[86]+c[88])
