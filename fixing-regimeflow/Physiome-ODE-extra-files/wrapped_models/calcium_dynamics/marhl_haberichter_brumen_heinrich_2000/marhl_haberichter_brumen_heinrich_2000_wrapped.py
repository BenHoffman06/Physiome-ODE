...
class Config:
    def __init__(
        ...
        self.model_name = "marhl_haberichter_brumen_heinrich_2000"
        self.curve_names = [
            "Ca_cyt",
            "Ca_ER",
            "Ca_m",
        ]
        self.state_names = ['Ca_cyt', 'Ca_ER', 'Ca_m']
        self.algebraic_names = ['Ca_Pr', 'Pr', 'J_pump', 'J_ch', 'J_leak', 'J_in', 'J_out']
        self.params = param
        self.T = T
        self.T_unit = T_unit
