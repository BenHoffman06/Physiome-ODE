...
class Parameters:
    def __init__(self):
        ...
        self.ADP = 20e-3
        self.P_i = 1
        self.legend_constants_27 = 0.100000
    ...
    def to_dict(self):
        return {
            ...
            "ADP": self.ADP,
            "P_i": self.P_i,
            "legend_constants_27": self.legend_constants_27,
        }
...
class Config:
    def __init__(
        ...
        self.model_name = "tran_smith_loiselle_crampin_2009_variant01"
        self.curve_names = [
            "ATP",
        ]
        self.state_names = ['ATP']
        self.algebraic_names = ['T_ATP', 'a_p1', 'a_m2', 's2', 'v_cycle']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[20] = c[14]/c[7]
        c[21] = c[15]/c[8]
        c[22] = (power(c[15], c[12]))/c[9]
        c[23] = (power(c[15], c[12]))/c[10]
        c[24] = c[15]/c[11]
        c[25] = (c[2]*c[23])/(c[23]*(1.00000+c[24])+c[24]*(1.00000+power(c[20], 2.00000)))
        c[26] = (c[4]*c[16]*(power(c[20], 2.00000))*c[24])/(c[23]*(1.00000+c[24])+c[24]*(1.00000+power(c[20], 2.00000)))
