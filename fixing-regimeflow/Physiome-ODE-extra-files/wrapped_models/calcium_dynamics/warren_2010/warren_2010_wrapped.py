...
class Parameters:
    def __init__(self):
        ...
        self.gamma = 4.9
        self.PIP2_Total = 5
        self.PIP2_Total_1 = 25
        self.J_ip3R0 = 10
        self.MechanicalStimulation = 0
        self.V_mech0 = 1
        self.C_1 = 2.6
        self.C_2 = 0.02
        self.C_3 = 2.3
    ...
    def to_dict(self):
        return {
            "volume_i0": self.volume_i0,
            "gamma": self.gamma,
            "PIP2_Total": self.PIP2_Total,
            "PIP2_Total_1": self.PIP2_Total_1,
            "J_ip3R0": self.J_ip3R0,
            "MechanicalStimulation": self.MechanicalStimulation,
            "V_mech0": self.V_mech0,
            "C_1": self.C_1,
            "C_2": self.C_2,
            "C_3": self.C_3,
            "C_4": self.C_4,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[75.8335890358239, 1199.73747802144, -3.28287434380887e-93, 1, 0, -2.42013500345263e-89, 2.24343309680416e-81, 1.01276768045278e-40],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "warren_2010"
        self.curve_names = [
            "volumeCa_i",
            "volumeCa_er",
            "volume_iIP3",
        ...
        self.state_names = ['volumeCa_i', 'volumeCa_er', 'volume_iIP3', 'PIP2', 'ATP_e', 'O', 'I1', 'I2']
        self.algebraic_names = ['Ca_i', 'IP3', 'W_inf', 'Ca_er', 'IPX', 'Pryr', 'V_mech', 'S', 'k4', 'V_IP3', 'Pipt', 'k1', 'J_ip3P', 'Jipt', 'F_Ca', 'Jryr', 'J_ip3D', 'Jer', 'Jserca', 'V_Ca', 'Iin_1', 'Iin_2', 'Jin_1', 'Jin_2', 'Jin', 'Jpm']
        self.params = param
        self.T = T
        self.T_unit = T_unit
