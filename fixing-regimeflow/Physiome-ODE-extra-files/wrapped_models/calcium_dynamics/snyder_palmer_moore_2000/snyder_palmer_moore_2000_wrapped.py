...
class Parameters:
    def __init__(self):
        self.Ca_e = 0.002
        self.k1 = 0.2
        self.k_on1 = 2000000000
        self.k_off1 = 1400
        self.k_on2 = 13000000
        self.k_off2 = 3.9
        self.k_s = 9
        self.Km_NaCaX = 0.000036
        self.Vmax_NaCaX = 0.0012
        self.kf = 2500
        self.Km_s = 0.00000025
        self.Vmax_s = 0.000525
        self.K_ons = 8772
        self.K_offs = 5.596536
        self.Bmax_s = 0.008
        self.Rt = 0.00000015
        self.Bmax_f1 = 0.0002
        self.Bmax_f2 = 0.0011
    ...
    def to_dict(self):
        return {
            ...
            "k_off2": self.k_off2,
            "k_s": self.k_s,
            "Km_NaCaX": self.Km_NaCaX,
            "Vmax_NaCaX": self.Vmax_NaCaX,
            "kf": self.kf,
            "Km_s": self.Km_s,
            "Vmax_s": self.Vmax_s,
            "K_ons": self.K_ons,
            ...
            "Bmax_s": self.Bmax_s,
            "Rt": self.Rt,
            "Bmax_f1": self.Bmax_f1,
            "Bmax_f2": self.Bmax_f2,
            "Kb_f1": self.Kb_f1,
            "Kb_f2": self.Kb_f2,
            "V_f": self.V_f,
            "Bmax_c": self.Bmax_c,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.12e-6, 0, 0, 0, 0, 201e-6, 0, 0, 1e-7, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "snyder_palmer_moore_2000"
        self.curve_names = [
            "Ca_f",
            "Ca_2_S1",
            "Ca_S2",
        ...
        self.state_names = ['Ca_f', 'Ca_2_S1', 'Ca_S2', 'S1', 'S2', 'Ca_s', 'cas1', 'cas2', 'Ca_c', 'Ca_CSQ']
        self.algebraic_names = ['dCa2_S1_dt', 'dCa_S2_dt', 'Rate_Ca_influx_across_the_SR', 'r_o', 'dcas1_dt', 'dcas2_dt', 'Rate_Ca_movement_through_the_SRRC', 'Rate_Ca_efflux_across_the_SR_by_NaCa_exchange', 'Rate_Ca_movement_between_the_fuzzy_space_and_cytosol', 'Rate_Ca_uptake_by_SR_Ca_ATPase', 'Rate_Ca_buffering_in_the_SR']
        self.params = param
        self.T = T
        self.T_unit = T_unit
