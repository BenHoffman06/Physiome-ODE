...
class Parameters:
    def __init__(self):
        ...
        self.betaTF = 0.07
        self.feedbackOn = 1
        self.deltaPhzMS = 8.0225e-6
        self.alphaPYO = 1.3
        self.deltaPYO = 5.8e-1
        self.Jgain_TFS = 0.00000
        self.Jgain_PYO = 0.00000

    def to_dict(self):
        return {
            "alphaTF": self.alphaTF,
            "s": self.s,
            "betaTFS": self.betaTFS,
            "kd": self.kd,
            "deltaTFS": self.deltaTFS,
            "deltaTF": self.deltaTF,
            "gammaPhzMS": self.gammaPhzMS,
            "betaPhzMS": self.betaPhzMS,
            "gammaTF": self.gammaTF,
            "betaTF": self.betaTF,
            "feedbackOn": self.feedbackOn,
            "deltaPhzMS": self.deltaPhzMS,
            "alphaPYO": self.alphaPYO,
            "deltaPYO": self.deltaPYO,
            "Jgain_TFS": self.Jgain_TFS,
            "Jgain_PYO": self.Jgain_PYO,
        }
...
class Config:
    def __init__(
        ...
        self.model_name = "gilbert_heiner_rosser_fulton_gu_trybilo_2007"
        self.curve_names = [
            "TFS",
            "TF",
            "PhzMS",
        ...
        self.state_names = ['TFS', 'TF', 'PhzMS', 'PYO']
        self.algebraic_names = ['Jassociation', 'JPhzMS', 'JPYOformation', 'JTF', 'Jgain_PhzMS', 'Jgain_TF']
        self.params = param
        self.T = T
        self.T_unit = T_unit
