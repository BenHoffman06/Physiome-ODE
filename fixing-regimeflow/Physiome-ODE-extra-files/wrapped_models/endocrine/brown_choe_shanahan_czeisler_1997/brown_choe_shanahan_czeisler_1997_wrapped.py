...
class Parameters:
    def __init__(self):
        ...
        self.tau_I = 2.82
        self.tau_C = 23.67
        self.tau_alpha = 25.92
        self.tau_lamda = 24.04
...
class Config:
    def __init__(
        ...
        self.model_name = "brown_choe_shanahan_czeisler_1997"
        self.curve_names = [
            "H1",
            "H2",
        ]
        self.state_names = ['H1', 'H2']
        self.algebraic_names = ['A']
        self.params = param
        self.T = T
        self.T_unit = T_unit
