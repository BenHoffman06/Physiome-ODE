...
class Config:
    def __init__(
        ...
        self.model_name = "tabak_toporikova_freeman_bertram_2007_a"
        self.curve_names = [
            "V",
            "n",
            "Ca",
        ...
        self.algebraic_names = ['I_K', 'n_infinity', 'h_infinity', 'PRL', 'm_infinity', 'I_Ca', 's_infinity', 'I_SK', 'f_infinity', 'I_BK', 'I_DA']
        self.params = param
        self.T = T
        self.T_unit = T_unit
