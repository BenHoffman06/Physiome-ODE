...
class Config:
    def __init__(
        ...
        self.model_name = "komarova_2003b"
        self.curve_names = [
            "x1",
            "x2",
            "z",
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[10] = c[6]*c[3]-(1.00000-c[2])*(1.00000-c[7])
        c[11] = (power(c[1]/c[0], (1.00000-c[7])/c[10]))*(power(c[5]/c[4], c[3]/c[10]))
        c[12] = (power(c[1]/c[0], c[6]/c[10]))*(power(c[5]/c[4], (1.00000-c[2])/c[10]))
