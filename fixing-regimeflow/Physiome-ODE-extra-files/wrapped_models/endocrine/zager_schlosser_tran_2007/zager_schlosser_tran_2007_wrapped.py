...
class Config:
    def __init__(
        ...
        self.model_name = "zager_schlosser_tran_2007"
        self.curve_names = [
            "Cgen_pp",
            "Cgen_rp",
            "Cgen_l",
        ...
        self.state_names = ['Cgen_pp', 'Cgen_rp', 'Cgen_l', 'Cgen_GI', 'Ccon_l', 'Ccon_ROB', 'Acon_b']
        self.algebraic_names = ['H_Cgen_pp', 'H_Cgen_rp', 'H_Cgen_l', 'H_Cgen_GI', 'H_Ccon_l', 'd_t_Cgen_l', 'Cgen_B', 'H_Ccon_ROB', 'H_Cgen_B', 'F', 'H', 'vinf']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[19] = 14.1000*(power(c[18], 0.750000))
        c[22] = 0.528000*c[19]
        c[23] = 0.289000*c[19]
        c[24] = 0.0300000*c[19]
        c[25] = 0.153000*c[19]
