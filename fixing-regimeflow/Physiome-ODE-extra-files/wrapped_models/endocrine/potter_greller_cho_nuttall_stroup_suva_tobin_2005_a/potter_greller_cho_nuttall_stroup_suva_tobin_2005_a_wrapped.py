...
def createLegends():
    ...
    legend_constants[11] = "D in component model_parameters (flux)"
    ...
    legend_algebraic[0] = "rho in component rho (dimensionless)"
    legend_constants[9] = "De in component model_parameters (flux)"
    legend_constants[10] = "Dd in component model_parameters (flux)"
...
def computeRates(voi, states, constants):
    ...
    rates[0] = (constants[1]*states[1]+constants[3]*states[2]+constants[11])-(constants[0]*states[3]*states[0]+constants[2]*states[4]*states[0]+constants[4]*states[0])
...
class Config:
    def __init__(
        ...
        self.model_name = "potter_greller_cho_nuttall_stroup_suva_tobin_2005_a"
        self.curve_names = [
            "P",
            "Ca",
            "Ci",
