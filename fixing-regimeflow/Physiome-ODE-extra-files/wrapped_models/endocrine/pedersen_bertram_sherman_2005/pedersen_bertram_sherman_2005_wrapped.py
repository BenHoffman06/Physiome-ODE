...
class Parameters:
    def __init__(self):
        ...
        self.ki = 0.1
        self.topa1 = 0.00000
        self.weight1 = 1.00000
        self.bottom1 = 1.00000

    def to_dict(self):
        return {
            "gluper": self.gluper,
            "gluamp": self.gluamp,
            "glubasa1": self.glubasa1,
            "glustep": self.glustep,
            ...
            "r": self.r,
            "r1": self.r1,
            "autoadp": self.autoadp,
            "adpknot": self.adpknot,
            "ky": self.ky,
            "kg": self.kg,
            "cm": self.cm,
            "gK": self.gK,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[6.0637, 525.97, 0.2088, 537.6, 0.05626, -66.7, 0.00012, 121.8, 0.316],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "pedersen_bertram_sherman_2005"
        self.curve_names = [
            "Gi",
            "G6P",
            "FBP",
        ...
        self.state_names = ['Gi', 'G6P', 'FBP', 'ADP', 'Ca', 'v', 'n', 'Caer', 'I']
        self.algebraic_names = ['GeStep', 'tau_n', 'I_infinity', 'Ge', 'n_infinity', 'F6P', 'Jglut', 'Jgk', 'JGPDH', 'weight5', 'weight3', 'topa3', 'weight7', 'rad', 'ATP', 'weight2', 'y', 'I_K', 'bottom2', 'fback', 'm_infinity', 'bottom3', 'I_Ca', 'weight6', 'I_K_Ca', 'Jmem', 'weight4', 'MgADP', 'JSERCA', 'topa4', 'topo', 'Jleak', 'topa5', 'ADP3', 'Jer', 'topa6', 'ATP4', 'bottom4', 'bottomo', 'bottom5', 'katpo', 'bottom6', 'I_K_ATP', 'topa7', 'bottom7', 'weight8', 'topa8', 'topa9', 'topa10', 'bottom8', 'AMP', 'weight9', 'bottom9', 'weight13', 'weight11', 'topa11', 'weight10', 'bottom10', 'bottom11', 'weight15', 'topb', 'weight12', 'topa12', 'topa13', 'bottom12', 'bottom13', 'weight14', 'topa14', 'topa15', 'bottom14', 'bottom15', 'weight16', 'topa16', 'bottom16', 'JPFK']
        self.params = param
        self.T = T
        self.T_unit = T_unit
