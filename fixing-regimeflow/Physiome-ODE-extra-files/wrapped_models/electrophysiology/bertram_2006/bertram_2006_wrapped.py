...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.6, 7.4, 93, 0.1, 0.1, 1850, 0.5],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "bertram_2006"
        self.curve_names = [
            "NADHm",
            "ADPm",
            "PSIm",
        ...
        self.state_names = ['NADHm', 'ADPm', 'PSIm', 'Cam', 'c', 'ADPc', 'FBP']
        self.algebraic_names = ['NADm', 'ATPm', 'heav_on', 'heav_Cton1', 'MM1', 'RATm', 'heav_off', 'heav_Cton2', 'Jo', 'ATPc', 'Fproto', 'heav_Cton3', 'Jgpdh', 'Jh_yd', 'heav_Ctoff1', 'Jpdh', 'Juni', 'pulse1', 'Jnaca', 'heav_Ctoff2', 'Jh_leak', 'Jmito', 'pulse2', 'MM2', 'heav_Ctoff3', 'Jh_res', 'pulse3', 'b13', 'Cproto', 'Jh_atp', 'b2', 'Jf1f0', 'Jant']
        self.params = param
        self.T = T
        self.T_unit = T_unit
