...
class Parameters:
    def __init__(self):
        ...
        self.Cl_i = 88
        self.G_max_Ltype = 2
        self.J_max_PMCA = 0.088464
        self.G_max_VDDR = 3
        self.tau_d_CaCl = 0.03
        self.G_max_CaCl = 10.1
        self.G_max_BK = 23
        self.G_max_bk = 0.15
        self.G_max_ERG = 2.5
        self.G_max_kv11 = 6.3
        self.G_max_Na = 20
        self.tau_d_NSCC = 0.35
        self.G_max_NSCC = 12.15
        self.NaPerm_o_Kperm = 1.056075
        self.P_PU = 0.001
        self.P_mito = 0.12871
        self.P_ER = 0.1
        self.fe = 0.01
        ...
        self.nhyd = 2.7
        self.K_hyd = 0.05125
        self.J_ERleak = 1.666667
        self.Jmax_IP3 = 50000
        self.d_IP3 = 0.00025
        self.d_ACT = 0.001
        self.d_INH = 0.0014
        self.tauh = 4
        self.Jmax_serca = 1.8333
        self.k_serca = 0.00042
        self.conc = 0.001
        self.Jmax_uni = 5000
        self.Jmax_NaCa = 0.05
        self.J_max_leak = 0.01
        self.rho_res = 0.4
        self.rho_F1 = 0.7
        self.g_H = 0.0033333
        self.J_red_basal = 0.3333
        self.Jmax_ANT = 15
        self.J_hyd_max = 0.037625
        self.Glc = 1
        self.total_NAD_m = 8
        self.total_ANP_m = 12
        self.total_ANP_i = 2
    ...
    def to_dict(self):
        return {
            ...
            "J_max_PMCA": self.J_max_PMCA,
            "G_max_VDDR": self.G_max_VDDR,
            "tau_d_CaCl": self.tau_d_CaCl,
            "G_max_CaCl": self.G_max_CaCl,
            "G_max_BK": self.G_max_BK,
            "G_max_bk": self.G_max_bk,
            "G_max_ERG": self.G_max_ERG,
            "G_max_kv11": self.G_max_kv11,
            "G_max_Na": self.G_max_Na,
            "tau_d_NSCC": self.tau_d_NSCC,
            "G_max_NSCC": self.G_max_NSCC,
            "NaPerm_o_Kperm": self.NaPerm_o_Kperm,
            "P_PU": self.P_PU,
            "P_mito": self.P_mito,
            "P_ER": self.P_ER,
            "fe": self.fe,
            ...
            "K_act": self.K_act,
            "na": self.na,
            "deltaPsi_star": self.deltaPsi_star,
            "K_Na": self.K_Na,
            "K_Ca": self.K_Ca,
            ...
            "nhyd": self.nhyd,
            "K_hyd": self.K_hyd,
            "J_ERleak": self.J_ERleak,
            "Jmax_IP3": self.Jmax_IP3,
            "d_IP3": self.d_IP3,
            "d_ACT": self.d_ACT,
            "d_INH": self.d_INH,
            "tauh": self.tauh,
            "Jmax_serca": self.Jmax_serca,
            "k_serca": self.k_serca,
            "conc": self.conc,
            "Jmax_uni": self.Jmax_uni,
            "Jmax_NaCa": self.Jmax_NaCa,
            "J_max_leak": self.J_max_leak,
            "rho_res": self.rho_res,
            "rho_F1": self.rho_F1,
            "g_H": self.g_H,
            "J_red_basal": self.J_red_basal,
            "Jmax_ANT": self.Jmax_ANT,
            "J_hyd_max": self.J_hyd_max,
            "Glc": self.Glc,
            "total_NAD_m": self.total_NAD_m,
            "total_ANP_m": self.total_ANP_m,
            "total_ANP_i": self.total_ANP_i,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-67, 0.00000993087, 0, 1, 1, 0, 1, 0, 0, 0, 1, 0, 1, 0.0000902, 0, 0.000136, 0.007299, 2.60093454, 0.0077282, 0.101476, 0.9397, 164.000044],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "corrias_buist_2008"
        self.curve_names = [
            "Vm",
            "Ca_i",
            "d_Ltype",
        ...
        self.state_names = ['Vm', 'Ca_i', 'd_Ltype', 'f_Ltype', 'f_ca_Ltype', 'd_VDDR', 'f_VDDR', 'd_CaCl', 'd_ERG', 'd_kv11', 'f_kv11', 'd_Na', 'f_Na', 'Ca_PU', 'd_NSCC', 'Ca_m', 'Ca_ER', 'ADP_m', 'ADP_i', 'NADH_m', 'h', 'deltaPsi']
        self.algebraic_names = ['d_inf_Ltype', 'f_inf_Ltype', 'f_ca_inf_Ltype', 'd_inf_VDDR', 'f_inf_VDDR', 'd_inf_CaCl', 'd_inf_ERG', 'd_inf_kv11', 'f_inf_kv11', 'd_inf_Na', 'f_inf_Na', 'd_inf_NSCC', 'E_Ca', 'I_Ltype', 'J_PMCA', 'E_Ca_1', 'I_VDDR', 'I_CaCl', 'J_ERout', 'd_BK', 'J_SERCA', 'I_BK', 'MWC', 'J_uni', 'I_bk', 'J_NaCa', 'I_ERG', 'f_PDHa', 'J_leak', 'I_kv11', 'PMF', 'I_Na', 'J_Hleak', 'I_NSCC', 'NAD_m', 'A_res', 'J_o', 'J_Hres', 'ATP_m', 'ADP_mfree', 'A_F1', 'J_pF1', 'J_HF1', 'ADP3_m', 'ATP4_m', 'ATP_i', 'J_glyTotal', 'J_pTCA', 'J_red', 'J_pGly', 'J_hyd', 'ADP_ifree', 'MgADP_i', 'ADP3_i', 'ATP4_i', 'J_ANT']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[104] = power(c[6], (c[0]-c[1])/10.0000)
        c[105] = power(c[5], (c[0]-c[1])/10.0000)
        c[106] = power(c[4], (c[0]-c[1])/10.0000)
        c[107] = 1.10000*(c[0]-c[1])
        c[108] = c[2]/(c[3]*c[0])
        c[109] = (c[3]*c[0])/c[2]
        c[110] = c[12]*c[13]
        c[111] = c[106]*0.00100000
        c[112] = c[106]*0.0860000
        c[113] = c[106]*0.00200000
        c[114] = c[106]*0.00600000
        c[115] = c[106]*0.0400000
        c[116] = c[109]*log(c[17]/c[10])
        c[117] = c[109]*log(c[9]/c[16])
        c[118] = c[109]*log(c[9]/c[16])
        c[119] = c[105]*0.00300000
        c[120] = c[109]*log(c[9]/c[16])
        c[121] = c[105]*0.00500000
        c[122] = c[105]*0.00500000
        c[123] = c[109]*log(c[9]/c[16])
        c[124] = c[104]*0.00300000
        c[125] = c[104]*0.00160000
        c[126] = c[109]*log(c[8]/c[15])
        c[127] = c[109]*log((c[9]+c[8]*c[30])/(c[16]+c[15]*c[30]))
        c[128] = c[12]*c[32]
        c[129] = c[12]*c[31]
        c[130] = c[12]*c[33]
        c[131] = c[99]/(1.00000+power(c[79]/c[100], c[80]))
