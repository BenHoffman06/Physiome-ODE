...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-75, 0.05, 0.6, 0.325],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "hodgkin_huxley_1952"
        self.curve_names = [
            "V",
            "m",
            "h",
        ...
        self.state_names = ['V', 'm', 'h', 'n']
        self.algebraic_names = ['i_Stim', 'alpha_m', 'alpha_h', 'alpha_n', 'i_Na', 'beta_m', 'beta_h', 'beta_n', 'i_K', 'i_L']
        self.params = param
        self.T = T
        self.T_unit = T_unit
