...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-85.35765, 5.3367, 140.096, 6.9366, 3.792e-5, 3.5095e-6, 0.00448, 0.9704, 0.00077, 4.171e-12, 0.999997, 0.99279, 0.459, 0.9379, 2.6578e-5, 0.3342, 0.31007, 0.0112, 0.9059, 0.001419, 0.000932],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "espinosa_1998_hypertrophic"
        self.curve_names = [
            "V",
            "K_o",
            "K_i",
