...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-78.041367, 0.02566853, 0.78656359, 0.00293135, 0.80873917, 0.75473994, 0.02030289, 0.0176854, 3.11285794, 0.13500116],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "mcallister_noble_tsien_1975_b"
        self.curve_names = [
            "V",
            "m",
            "h",
        ...
        self.state_names = ['V', 'm', 'h', 'd', 'f', 's', 'x1', 'x2', 'q', 'r']
        self.algebraic_names = ['i_Na', 'alpha_m', 'alpha_h', 'alpha_d', 'alpha_f', 'alpha_s', 'alpha_x1', 'alpha_x2', 'alpha_q', 'alpha_r', 'd1', 'beta_m', 'beta_h', 'beta_d', 'beta_f', 'beta_s', 'beta_x1', 'beta_x2', 'beta_q', 'beta_r', 'i_si', 'I_K2', 'i_K2', 'I_x1', 'i_x1', 'I_x2', 'i_x2', 'i_qr', 'i_K1', 'i_Na_b', 'i_Cl_b']
        self.params = param
        self.T = T
        self.T_unit = T_unit
