...
class Parameters:
    ...
    def to_dict(self):
        return {
            ...
            "g_Ca": self.g_Ca,
            "P": self.P,
            "kb_plus": self.kb_plus,
            "kb_minus": self.kb_minus,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0, -65, 0, 1, 0, 0, 0, 0, 0, 0, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "bertram_arnot_zamponi_2002_post"
        self.curve_names = [
            "R",
            "V_post",
            "b",
        ...
        self.state_names = ['R', 'V_post', 'b', 'C1', 'C2', 'C_G1', 'C3', 'C_G2', 'C4', 'C_G3', 'n_post']
        self.algebraic_names = ['T', 'i_V', 'C_G', 'i_syn', 'alpha_n', 'sigma', 'i_leak_post', 'beta_n', 'Ca_open', 'alpha_x', 'alpha', 'beta_x', 'alpha_', 'x_infinity', 'beta', 'i_Na_post', 'O', 'beta_', 'i_K_post', 'Ca', 'kG_plus']
        self.params = param
        self.T = T
        self.T_unit = T_unit
