...
class Parameters:
    def __init__(self):
        ...
        self.Km_Na_i = 10
        self.Km_K_o = 1.5
        self.i_NaK_max = 0.59933874
        self.g_B_Na = 0.0006744375
        self.g_B_Ca = 0.001131
        self.g_B_K = 0
        self.Ca_o = 1.8
        self.I_NaCa_max = 1600
        self.K_mNa = 87.5
        self.K_mCa = 1.38
        self.K_sat = 0.1
        self.gamma = 0.35
        self.i_CaP_max = 0.275
        self.K_rel = 30
        self.tau_tr = 180
        self.I_up_max = 0.005
        self.K_up = 0.00092
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-81.18, 1.117e+01, 2.908e-3, 9.649e-1, 9.775e-1, 1.39e+02, 3.043e-2, 9.992e-1, 4.966e-3, 9.986e-1, 3.296e-5, 1.869e-2, 1.013e-4, 1.367e-4, 9.996e-1, 7.755e-1, 1.488, 2.35e-112, 1, 0.9992, 1.488],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "courtemanche_ramirez_nattel_1998"
        self.curve_names = [
            "V",
            "Na_i",
            "m",
        ...
        self.state_names = ['V', 'Na_i', 'm', 'h', 'j', 'K_i', 'oa', 'oi', 'ua', 'ui', 'xr', 'xs', 'Ca_i', 'd', 'f', 'f_Ca', 'Ca_rel', 'u', 'v', 'w', 'Ca_up']
        self.algebraic_names = ['i_st', 'alpha_m', 'alpha_h', 'alpha_j', 'alpha_oa', 'alpha_oi', 'alpha_ua', 'alpha_ui', 'alpha_xr', 'alpha_xs', 'd_infinity', 'f_infinity', 'f_Ca_infinity', 'tau_w', 'Ca_CMDN', 'Ca_TRPN', 'Ca_CSQN', 'E_Na', 'beta_m', 'beta_h', 'beta_j', 'beta_oa', 'beta_oi', 'beta_ua', 'beta_ui', 'beta_xr', 'beta_xs', 'tau_d', 'tau_f', 'w_infinity', 'i_Na', 'm_inf', 'h_inf', 'j_inf', 'tau_oa', 'tau_oi', 'tau_ua', 'tau_ui', 'tau_xr', 'tau_xs', 'E_K', 'tau_m', 'tau_h', 'tau_j', 'oa_infinity', 'oi_infinity', 'ua_infinity', 'ui_infinity', 'xr_infinity', 'xs_infinity', 'i_K1', 'i_to', 'g_Kur', 'i_Kur', 'i_Kr', 'i_Ks', 'i_Ca_L', 'f_NaK', 'i_NaK', 'E_Ca', 'i_B_K', 'i_B_Na', 'i_B_Ca', 'i_NaCa', 'i_CaP', 'i_rel', 'Fn', 'i_tr', 'u_infinity', 'tau_v', 'i_up', 'v_infinity', 'i_up_leak', 'B1', 'B2']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[43] = c[42]*0.680000
        c[45] = (1.00000/7.00000)*(exp(c[10]/67.3000)-1.00000)
        c[47] = 0.00480000*c[42]
        c[48] = 0.0552000*c[42]
