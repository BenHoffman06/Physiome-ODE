...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[25.0, 10000.0, 0.0, 4.0, 0.0, 0.0, 50.0, 0.0, 50.0, 0.0, 2.0, 0.0, 0.0, 10000.0, 0.0, 0.0, 100.0, 0.0, 0.0, 0.0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "cui_kaandorp_lloyd_2008_b"
        self.curve_names = [
            "Py",
            "Zn",
            "Py1",
        ...
        self.state_names = ['Py', 'Zn', 'Py1', 'Dw', 'Qw2', 'Qw1', 'Rw', 'Mw', 'Px', 'Px1', 'Dz', 'Qz4', 'Qz2', 'Tp', 'Tp1', 'Qz1', 'Rz', 'Qz3', 'Qz5', 'Mz']
        self.algebraic_names = ['k3']
        self.params = param
        self.T = T
        self.T_unit = T_unit
