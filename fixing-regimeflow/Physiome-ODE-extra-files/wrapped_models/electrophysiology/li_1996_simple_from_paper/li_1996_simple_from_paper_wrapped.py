...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-64, -25.0, 0.002, 1, 5.09],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "li_1996_simple_from_paper"
        self.curve_names = [
            "V_s",
            "V_D",
            "n",
        ...
        self.algebraic_names = ['I_K_DR', 'I_L', 'n_infinity', 'h_infinity', 'm_infinity', 'phi_Na', 'tau_h', 'tau_n', 'I_Na', 'I_pump', 'I_NMDA', 'I_Na_NMDA', 'I_D']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[19] = (power(c[14], 3.00000))/(power(c[14], 3.00000)+power(c[15], 3.00000))
