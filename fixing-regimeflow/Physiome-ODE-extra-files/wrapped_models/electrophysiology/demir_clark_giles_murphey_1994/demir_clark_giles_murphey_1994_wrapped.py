...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-49.54105, 139.9988, 0.250113, 0.001386897, 0.002065463, 0.002572773, 0.98651, 0.02012114, 0.1945111, 0.02302278, 0.3777728, 0.09227776, 9.701621, 5.389014, 3.787018e-4, 2.00474, 1.407347e2, 0.1411678, 0.07331396, 0.7618549, 0.2097049, 16.95311, 16.85024, 0.9528726, 0.1133251, 0.0007594214, 0.8859153],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "demir_clark_giles_murphey_1994"
        self.curve_names = [
            "V",
            "Na_c",
            "m",
        ...
        self.state_names = ['V', 'Na_c', 'm', 'h1', 'h2', 'd_L', 'f_L', 'd_T', 'f_T', 'P_a', 'P_i', 'y', 'Na_i', 'K_c', 'Ca_i', 'Ca_c', 'K_i', 'Ca_Calmod', 'Ca_Trop', 'Ca_Mg_Trop', 'Mg_Mg_Trop', 'Ca_up', 'Ca_rel', 'Ca_Calse', 'F1', 'F2', 'F3']
        self.algebraic_names = ['alpha_m', 'alpha_h1', 'alpha_f_L', 'alpha_d_T', 'alpha_f_T', 'P_a_infinity', 'alpha_P_i', 'y_infinity', 'alpha_d_L', 'phi_TMgM', 'r_act', 'beta_m', 'beta_h1', 'beta_f_L', 'beta_d_T', 'beta_f_T', 'tau_P_a', 'beta_P_i', 'tau_y', 'beta_d_L', 'r_inact', 'm_infinity', 'h1_infinity', 'tau_f_L', 'tau_d_T', 'tau_f_T', 'tau_d_L', 'tau_m', 'tau_h1', 'f_L_infinity', 'd_T_infinity', 'f_T_infinity', 'd_L_infinity', 'h2_infinity', 'i_Ca_L', 'tau_h2', 'i_Ca_T', 'i_f_Na', 'i_f_K', 'i_f', 'i_NaK', 'i_Ca_P', 'i_NaCa', 'phi_C', 'phi_TC', 'phi_TMgC', 'F_C', 'F_TC', 'F_TMgC', 'phi_B', 'phi_Calse', 'K2', 'i_up', 'i_rel', 'E_Na', 'i_tr', 'i_Na', 'i_B_Na', 'E_K', 'i_K', 'i_B_K', 'E_Ca', 'i_B_Ca', 'i_B']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[34] = 0.00693000*(power(c[9]/1.00000, 0.590000))
        c[35] = 0.465000*c[23]
        c[36] = 0.136000*c[23]
        c[37] = (c[30]*c[31])/c[32]
        c[38] = 0.0116600*c[35]
        c[39] = 0.00129600*c[35]
