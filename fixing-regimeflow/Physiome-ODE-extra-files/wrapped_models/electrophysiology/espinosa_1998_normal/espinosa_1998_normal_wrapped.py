...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-86.27784, 5.3201028, 140.1333, 6.835, 7.07933e-5, 2.3455e-6, 0.003956, 0.9759885, 0.0008364, 3.06884e-12, 0.9999977, 0.994096, 0.4387865, 0.954689, 2.4223e-5, 0.479749, 0.43984, 0.0113161, 0.9402563, 0.0024448, 0.0017012],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "espinosa_1998_normal"
        self.curve_names = [
            "V",
            "K_o",
            "K_i",
        ...
        self.state_names = ['V', 'K_o', 'K_i', 'Na_i', 'Ca_i', 'x', 'm', 'h', 'Ca_ds', 'd', 'f', 'f2', 'f2ds', 's', 'r', 'Ca_up', 'Ca_rel', 'ActFrac', 'ProdFrac', 'Ca_Calmod', 'Ca_Trop']
        self.algebraic_names = ['E0_x', 'E0_m', 'alpha_h', 'E0_d', 'E0_f', 'alpha_s', 'i_Stim', 'VoltDep', 'alpha_x', 'alpha_m', 'beta_h', 'alpha_d', 'alpha_f', 'beta_s', 'E_Na', 'CaiReg', 'beta_x', 'beta_m', 'beta_d', 'beta_f', 'E_K', 'CadsReg', 'E_Ca', 'RegBindSite', 'E_mh', 'ActRate', 'i_K1', 'InactRate', 'I_K', 'SpeedRel', 'i_K', 'PrecFrac', 'i_Na', 'i_b_Na', 'i_b_K', 'i_Ca_L_Ca_cyt', 'i_Ca_L_K_cyt', 'i_Ca_L_Na_cyt', 'i_Ca_L_Ca_ds', 'i_Ca_L_K_ds', 'i_Ca_L_Na_ds', 'i_Ca_L', 'i_b_Ca', 'i_to', 'i_NaK', 'i_NaCa_cyt', 'i_NaCa_ds', 'K_2', 'i_NaCa', 'i_up', 'i_trans', 'i_rel']
        self.params = param
        self.T = T
        self.T_unit = T_unit
