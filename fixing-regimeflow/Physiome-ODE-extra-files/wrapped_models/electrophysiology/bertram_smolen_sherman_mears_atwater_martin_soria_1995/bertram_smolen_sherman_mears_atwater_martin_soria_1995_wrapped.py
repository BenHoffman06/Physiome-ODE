...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-61, 0.0005, 0.12, 0.11, 9],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "bertram_smolen_sherman_mears_atwater_martin_soria_1995"
        self.curve_names = [
            "V",
            "n",
            "jm",
        ...
        self.state_names = ['V', 'n', 'jm', 'Ca_i', 'Ca_er']
        self.algebraic_names = ['n_infinity', 'i_K', 'j', 'jm_infinity', 'tau_n', 'i_K_ATP', 'tau_j', 'm_f_infinity', 'i_Ca_f', 'm_s_infinity', 'i_Ca_s', 'i_Ca', 'i_K_Ca', 'J_er_p', 'r_infinity', 'a_infinity', 'i_CRAC', 'h_infinity', 'i_leak', 'O', 'J_er_leak', 'J_er_IP3', 'J_er_tot', 'J_mem_tot']
        self.params = param
        self.T = T
        self.T_unit = T_unit
