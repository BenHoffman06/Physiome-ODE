...
class Config:
    def __init__(
        ...
        self.state_names = ['u', 'v', 'w', 's']
        self.algebraic_names = ['Vm', 'J_stim', 'm', 'q', 'p', 'r', 'v_inf', 'tau_s', 'J_fi', 'tau_v_minus', 'w_inf', 'tau_o', 'tau_w_minus', 'tau_so', 'J_so', 'J_si']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[11] = custom_piecewise([equal(c[0] , 1.00000), 16.0000 , equal(c[1] , 1.00000), 2.00000 , True, 4.00000])
        c[12] = custom_piecewise([equal(c[0] , 1.00000), 1150.00 , equal(c[1] , 1.00000), 10.0000 , True, 1.45000])
        c[13] = custom_piecewise([equal(c[0] , 1.00000), 0.00600000 , equal(c[1] , 1.00000), 0.0240000 , True, 0.100000])
        c[14] = custom_piecewise([equal(c[0] , 1.00000), 400.000 , equal(c[1] , 1.00000), 470.000 , True, 410.000])
        c[15] = custom_piecewise([equal(c[0] , 1.00000), 0.00600000 , equal(c[1] , 1.00000), 0.00600000 , True, 0.00500000])
        c[16] = custom_piecewise([equal(c[0] , 1.00000), 0.110000 , equal(c[1] , 1.00000), 0.104000 , True, 0.0780000])
        c[17] = custom_piecewise([equal(c[0] , 1.00000), 1.55000 , equal(c[1] , 1.00000), 1.56000 , True, 1.61000])
        c[18] = custom_piecewise([equal(c[0] , 1.00000), 30.0200 , equal(c[1] , 1.00000), 40.0000 , True, 91.0000])
        c[19] = custom_piecewise([equal(c[0] , 1.00000), 0.996000 , equal(c[1] , 1.00000), 1.20000 , True, 0.800000])
        c[20] = custom_piecewise([equal(c[0] , 1.00000), 2.04600 , equal(c[1] , 1.00000), 2.00000 , True, 2.10000])
        c[21] = custom_piecewise([equal(c[0] , 1.00000), 0.650000 , equal(c[1] , 1.00000), 0.650000 , True, 0.600000])
        c[22] = custom_piecewise([equal(c[0] , 1.00000), 1.88750 , equal(c[1] , 1.00000), 2.90130 , True, 3.38490])
        c[23] = custom_piecewise([equal(c[0] , 1.00000), 0.0700000 , equal(c[1] , 1.00000), 0.0273000 , True, 0.0100000])
        c[24] = custom_piecewise([equal(c[0] , 1.00000), 0.940000 , equal(c[1] , 1.00000), 0.780000 , True, 0.500000])
        c[25] = custom_piecewise([equal(c[0] , 1.00000), 60.0000 , equal(c[1] , 1.00000), 6.00000 , True, 70.0000])
        c[26] = custom_piecewise([equal(c[0] , 1.00000), 15.0000 , equal(c[1] , 1.00000), 140.000 , True, 8.00000])
        c[27] = custom_piecewise([equal(c[0] , 1.00000), 65.0000 , equal(c[1] , 1.00000), 200.000 , True, 200.000])
        c[28] = custom_piecewise([equal(c[0] , 1.00000), 0.0300000 , equal(c[1] , 1.00000), 0.0160000 , True, 0.0160000])
        c[29] = custom_piecewise([equal(c[0] , 1.00000), 200.000 , equal(c[1] , 1.00000), 280.000 , True, 280.000])
        c[30] = custom_piecewise([equal(c[0] , 1.00000), 60.0000 , equal(c[1] , 1.00000), 75.0000 , True, 80.0000])
        c[31] = custom_piecewise([equal(c[0] , 1.00000), 6.00000 , equal(c[1] , 1.00000), 6.00000 , True, 7.00000])
