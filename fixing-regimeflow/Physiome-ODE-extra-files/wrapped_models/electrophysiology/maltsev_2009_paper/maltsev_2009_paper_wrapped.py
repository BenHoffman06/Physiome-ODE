...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-65, 0.000223, 0, 1, 1, 0, 1, 0, 0, 1, 0, 1, 0, 1, 0, 1, 0.7499955, 3.4e-6, 1.1e-6, 0.25, 0.029, 1.35, 0.0001, 0.69, 0.042, 0.089, 0.02, 0.22, 0.032],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "maltsev_2009_paper"
        self.curve_names = [
            "Vm",
            "Ca_sub",
            "dL",
