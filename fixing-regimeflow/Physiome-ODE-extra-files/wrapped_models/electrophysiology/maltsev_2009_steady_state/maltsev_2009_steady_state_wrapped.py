...
class Parameters:
    def __init__(self):
        ...
        self.E_CaL = 45
        self.g_CaL = 0.464
        self.alpha_fCa = 0.021
        self.Km_fCa = 0.00035
        self.g_CaT = 0.1832
        self.E_CaT = 45
        self.g_Kr = 0.08113973
        self.g_Ks = 0.0259
        self.g_to = 0.252
        self.g_sus = 0.02
        self.g_if = 0.15
        ...
        self.kb_CQ = 0.445
        self.Mgi = 2.5
        self.V_jsr_part = 0.0012
        self.V_i_part = 0.46
        self.V_nsr_part = 0.0116
        self.R_cell = 4
        self.L_cell = 70
        self.L_sub = 0.02
    ...
    def to_dict(self):
        return {
            ...
            "kb_CQ": self.kb_CQ,
            "Mgi": self.Mgi,
            "V_jsr_part": self.V_jsr_part,
            "V_i_part": self.V_i_part,
            "V_nsr_part": self.V_nsr_part,
            "R_cell": self.R_cell,
            "L_cell": self.L_cell,
            "L_sub": self.L_sub,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-57.9639346865, 0.000138112560112, 0.000584545564405, 0.862381249774, 0.711395919653, 0.00504393374639, 0.420757825415, 0.453100576739, 0.144755091176, 0.849409822329, 0.0264600410928, 0.694241313965, 0.00558131733359, 0.113643187247, 0.42380243163, 0.447294008304, 0.688047760973, 1.7340201253e-7, 7.86181717518e-8, 0.311951987007, 0.316762674605, 1.49348117734, 0.000150018670943, 0.501049376634, 0.0594880901438, 0.054381370046, 0.0291316176172, 0.432694959597, 0.273207128393],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "maltsev_2009_steady_state"
        self.curve_names = [
            "Vm",
            "Ca_sub",
            "dL",
        ...
        self.state_names = ['Vm', 'Ca_sub', 'dL', 'fL', 'fCa', 'dT', 'fT', 'paS', 'paF', 'pi_', 'n', 'q', 'r', 'y', 'qa', 'qi', 'R', 'O', 'I', 'RI', 'Ca_jsr', 'Ca_nsr', 'Cai', 'fTMM', 'fCMi', 'fCMs', 'fTC', 'fTMC', 'fCQ']
        self.algebraic_names = ['dL_infinity', 'fL_infinity', 'fCa_infinity', 'dT_infinity', 'fT_infinity', 'pa_infinity', 'pi_infinity', 'alpha_n', 'q_infinity', 'r_infinity', 'y_infinity', 'qa_infinity', 'alpha_qi', 'kCaSR', 'i_CaL', 'delta_fTMM', 'adVm', 'tau_fL', 'tau_fCa', 'tau_dT', 'tau_fT', 'tau_paS', 'tau_paF', 'tau_pi', 'beta_n', 'tau_q', 'tau_r', 'tau_y', 'alpha_qa', 'beta_qi', 'koSRCa', 'i_CaT', 'alpha_dL', 'n_infinity', 'beta_qa', 'qi_infinity', 'kiSRCa', 'i_Kr', 'bdVm', 'tau_n', 'tau_qa', 'tau_qi', 'i_Ks', 'beta_dL', 'i_to', 'tau_dL', 'i_sus', 'i_f_Na', 'i_f_K', 'i_f', 'i_st', 'i_b_Na', 'i_NaK', 'i_b_Ca', 'k41', 'di', 'k12', 'k14', 'k32', 'x2', 'do', 'k21', 'k23', 'x1', 'x3', 'x4', 'i_NaCa', 'j_SRCarel', 'j_Ca_dif', 'delta_fCMs', 'j_up', 'delta_fTC', 'j_tr', 'delta_fTMC', 'delta_fCQ', 'delta_fCMi']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[75] = ((c[1]*c[2])/c[3])*log(c[5]/c[4])
        c[76] = ((c[1]*c[2])/c[3])*log(c[7]/c[6])
        c[77] = ((c[1]*c[2])/c[3])*log((c[7]+0.120000*c[5])/(c[6]+0.120000*c[4]))
        c[78] = (c[1]*c[2])/c[3]
        c[79] = c[4]/(c[31]+c[4])
        c[80] = c[5]/(c[36]+c[5])
        c[81] = 0.00100000* pi*(power(c[72], 2.00000))*c[73]
        c[82] = 0.00100000*2.00000* pi*c[74]*(c[72]-c[74]/2.00000)*c[73]
        c[83] = c[69]*c[81]
        c[84] = c[70]*c[81]-c[82]
        c[85] = c[71]*c[81]
