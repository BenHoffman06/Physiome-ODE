...
class Parameters:
    def __init__(self):
        ...
        self.stim_period = 1
        self.stim_duration = 0.003
        self.stim_amplitude = -3
        self.P_kna = 0.03
        self.K_o = 4
        self.Na_o = 140
        self.Ca_o = 2
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-92.849333, 136.5644281, 7.3321223, 1.4e-5, 1.03e-5, 2e-7, 0.001302, 0.0016203, 0.9944036, 1.88e-5, 0, 1, 0.9349197, 0.9651958, 0.9948645, 0, 0.4531889, 0.4481927, 0.0042614, 0.4068154, 0.0005555, 0.0003542],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "noble_varghese_kohl_noble_1998_a"
        self.curve_names = [
            "V",
            "K_i",
            "Na_i",
        ...
        self.state_names = ['V', 'K_i', 'Na_i', 'Ca_i', 'xr1', 'xr2', 'xs', 'm', 'h', 'Ca_ds', 'd', 'f', 'f2', 'f2ds', 's', 'r', 'Ca_up', 'Ca_rel', 'ActFrac', 'ProdFrac', 'Ca_Calmod', 'Ca_Trop']
        self.algebraic_names = ['alpha_xr1', 'alpha_xr2', 'alpha_xs', 'E0_m', 'alpha_h', 'E0_d', 'E0_f', 'alpha_s', 'i_Stim', 'VoltDep', 'beta_xr1', 'beta_xr2', 'beta_xs', 'alpha_m', 'beta_h', 'alpha_d', 'alpha_f', 'beta_s', 'E_Na', 'CaiReg', 'beta_m', 'beta_d', 'beta_f', 'E_K', 'CadsReg', 'E_Ks', 'RegBindSite', 'E_Ca', 'ActRate', 'E_mh', 'InactRate', 'i_K1', 'SpeedRel', 'i_Kr', 'PrecFrac', 'i_Ks', 'i_Na', 'i_p_Na', 'i_b_Na', 'i_Ca_L_Ca_cyt', 'i_Ca_L_K_cyt', 'i_Ca_L_Na_cyt', 'i_Ca_L_Ca_ds', 'i_Ca_L_K_ds', 'i_Ca_L_Na_ds', 'i_Ca_L', 'i_b_Ca', 'i_to', 'i_NaK', 'i_NaCa_cyt', 'i_NaCa_ds', 'i_NaCa', 'K_2', 'i_up', 'i_trans', 'i_rel']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[66] = 3.14159*(power(c[59], 2.00000))*c[60]
        c[67] = (c[44]*c[45])/c[46]
        c[68] = ((1.00000-c[63])-c[64])-c[62]
        c[69] = c[66]*c[68]
