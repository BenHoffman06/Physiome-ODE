...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-93.7400119196694, 136.604284305878, 7.50547214142684, 1.34858164771406e-5, 0.00938586574433011, 0.00143405969732302, 0.995414125415674, 1.91821833548952e-8, 0.999999956287155, 0.997644968939185, 1.60424507876553e-8, 0.59333810408885, 0.591323137897127, 0.00267040300939318, 0.522949441962453, 0.000524570960945961, 0.00033477224086766],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "noble_noble_bett_earm_ho_so_1991"
        self.curve_names = [
            "V",
            "K_i",
            "Na_i",
        ...
        self.state_names = ['V', 'K_i', 'Na_i', 'Ca_i', 'x', 'm', 'h', 'd', 'f', 's', 'r', 'Ca_up', 'Ca_rel', 'ActFrac', 'ProdFrac', 'Ca_Calmod', 'Ca_Trop']
        self.algebraic_names = ['E0xa', 'E0_m', 'alpha_h', 'E0_d', 'E0_f', 'alpha_s', 'i_Stim', 'VoltDep', 'RegBindSite', 'alpha_x', 'alpha_m', 'beta_h', 'alpha_d', 'alpha_f', 'beta_s', 'E_Na', 'ActRate', 'E0xb', 'beta_m', 'beta_d', 'beta_f', 'E_K', 'InactRate', 'beta_x', 'E_Ca', 'PrecFrac', 'E_mh', 'i_K1', 'I_K', 'i_K', 'i_b_K', 'i_Na', 'i_b_Na', 'i_Ca_L_Ca', 'i_Ca_L_K', 'i_Ca_L_Na', 'i_Ca_L', 'i_b_Ca', 'i_to', 'i_NaK', 'i_NaCa', 'K_2', 'i_up', 'i_trans', 'i_rel']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[55] = 3.14159*(power(c[50], 2.00000))*c[51]
        c[56] = (c[36]*c[37])/c[38]
        c[57] = ((1.00000-c[53])-c[54])-c[52]
        c[58] = c[55]*c[57]
