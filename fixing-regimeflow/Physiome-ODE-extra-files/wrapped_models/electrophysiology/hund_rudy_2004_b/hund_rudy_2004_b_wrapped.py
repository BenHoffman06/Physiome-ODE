...
def initConsts():
    ...
    constants[57] = custom_piecewise([equal(constants[6] , 0.00000), 8.25000 , True, 4.00000*8.25000])
...
class Config:
    def __init__(
        ...
        self.model_name = "hund_rudy_2004_b"
        self.curve_names = [
            "V",
            "H",
            "m",
    ...
    def _build_constants(self):
        ...
        c[57] = (8.25000 if equal(c[6] , 0.00000) else 4.00000*8.25000)
