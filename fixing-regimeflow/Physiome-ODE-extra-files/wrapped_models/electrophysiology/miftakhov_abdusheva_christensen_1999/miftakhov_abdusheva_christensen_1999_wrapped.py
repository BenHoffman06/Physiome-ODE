...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-55.0, 0.01, 0.01, 0.01, 1E-4],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "miftakhov_abdusheva_christensen_1999"
        self.curve_names = [
            "V",
            "h",
            "x_Ca",
        ...
        self.state_names = ['V', 'h', 'x_Ca', 'n', 'Ca']
        self.algebraic_names = ['V_tilde', 'alpha_m', 'alpha_h', 'alpha_n', 'beta_m', 'beta_h', 'beta_n', 'm', 'i_Ca_T', 'i_Ca_L', 'i_K', 'i_Ca_K', 'i_Cl']
        self.params = param
        self.T = T
        self.T_unit = T_unit
