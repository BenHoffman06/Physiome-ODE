...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-60, 3, 140, 7.5, 0.007, 0.54, 5.8e-5, 0.076, 0.015, 0.0011, 0.785, 0.785, 1.98, 0.55, 0.785],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "noble_noble_1984"
        self.curve_names = [
            "V",
            "Kc",
            "Ki",
        ...
        self.state_names = ['V', 'Kc', 'Ki', 'Nai', 'y', 'x', 'Cai', 'm', 'h', 'd', 'f', 'f2', 'Ca_up', 'Ca_rel', 'p']
        self.algebraic_names = ['E_Na', 'E0_y', 'E0_x', 'E0_m', 'alpha_h', 'E0_d', 'E0_f', 'beta_f2', 'E0_p', 'E_K', 'alpha_y', 'alpha_x', 'alpha_m', 'beta_h', 'alpha_d', 'alpha_f', 'alpha_p', 'beta_y', 'beta_x', 'beta_m', 'beta_d', 'beta_f', 'i_fNa', 'beta_p', 'i_fK', 'i_f', 'I_K', 'i_K', 'i_K1', 'i_Na_b', 'E_Ca', 'i_Ca_b', 'i_p', 'i_NaCa', 'E_mh', 'i_Na', 'i_siCa', 'i_siK', 'i_up', 'i_siNa', 'i_tr', 'i_mK', 'i_si', 'i_rel']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[43] = (c[0]*c[1])/c[2]
        c[44] = 3.14159*(power(c[31], 2.00000))*c[32]
        c[45] = c[44]*(1.00000-c[33])
        c[46] = c[45]*0.0500000
        c[47] = c[45]*0.0200000
