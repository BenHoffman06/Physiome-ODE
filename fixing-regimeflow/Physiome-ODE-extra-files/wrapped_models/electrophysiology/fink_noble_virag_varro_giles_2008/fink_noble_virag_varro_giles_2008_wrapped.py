...
class Parameters:
    def __init__(self):
        ...
        self.g_to = 0.2
        self.g_Na = 11
        self.shift_INa_inact = 0
        self.g_bna = 0.00029
        self.g_CaL = 2e-5
        self.z = 2
        self.d_inf_shift = 5
        self.g_bca = 0.0004736
        self.g_pCa = 0.0619
        self.K_pCa = 0.0005
        self.g_pK = 0.00973
        self.P_NaK = 1.297
        ...
        self.Km_Nai = 87.5
        self.V_sr = 0.001094
        self.V_ss = 0.00005468
        self.Vol_xfer = 0.0038
        self.K_up = 0.00025
        self.Vol_leak = 0.00036
        self.Vmax_up = 0.006375
        self.k1_prime = 0.15
        self.k2_prime = 0.045
        self.EC = 1.5
        self.max_sr = 2.5
    ...
    def to_dict(self):
        return {
            ...
            "g_Kr_0": self.g_Kr_0,
            "T_Base": self.T_Base,
            "Sotalol_mM": self.Sotalol_mM,
            "kBinding": self.kBinding,
            "kDiss": self.kDiss,
            "g_Ks": self.g_Ks,
            "g_to": self.g_to,
            "g_Na": self.g_Na,
            "shift_INa_inact": self.shift_INa_inact,
            "g_bna": self.g_bna,
            "g_CaL": self.g_CaL,
            "z": self.z,
            "d_inf_shift": self.d_inf_shift,
            "g_bca": self.g_bca,
            "g_pCa": self.g_pCa,
            "K_pCa": self.K_pCa,
            "g_pK": self.g_pK,
            ...
            "V_sr": self.V_sr,
            "V_ss": self.V_ss,
            "Vol_xfer": self.Vol_xfer,
            "K_up": self.K_up,
            "Vol_leak": self.Vol_leak,
            "Vmax_up": self.Vmax_up,
            "k1_prime": self.k1_prime,
            ...
            "Buf_c": self.Buf_c,
            "K_buf_c": self.K_buf_c,
            "Buf_sr": self.Buf_sr,
            "K_buf_sr": self.K_buf_sr,
            "Buf_ss": self.Buf_ss,
            "K_buf_ss": self.K_buf_ss,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[-86.45, 141.0167, 7.940167, 1.092e-4, 0.014, 0.9786, 0.0031, 0.0029, 0.0014, 0, 0, 0, 0, 0, 0.00303, 1, 2.11e-8, 0.00132, 0.7768, 0.7766, 1.893e-4, 5.06e-6, 0.9999, 0.9995, 1, 2.7656, 0.9864],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "fink_noble_virag_varro_giles_2008"
        self.curve_names = [
            "V",
            "K_i",
            "Na_i",
        ...
        self.state_names = ['V', 'K_i', 'Na_i', 'Ca_i', 'Or4', 'Cr1', 'Cr2', 'Cr3', 'Ir5', 'BCr1', 'BCr2', 'BCr3', 'BOr4', 'BIr5', 'Xs', 's', 'r', 'm', 'h', 'j', 'Ca_ss', 'd', 'f', 'f2', 'fCass', 'Ca_SR', 'R_prime']
        self.algebraic_names = ['i_Stim', 'alpha_xr1', 'xs_inf', 's_inf', 'r_inf', 'm_inf', 'h_inf', 'j_inf', 'd_inf', 'f_inf', 'f2_inf', 'fCass_inf', 'E_Na', 'beta_xr1', 'alpha_xs', 'tau_s', 'tau_r', 'alpha_m', 'alpha_h', 'alpha_j', 'alpha_d', 'tau_f', 'tau_f2', 'tau_fCass', 'E_K', 'alpha_xr2', 'beta_xs', 'beta_m', 'beta_h', 'beta_j', 'beta_d', 'E_Ks', 'beta_xr2', 'tau_xs', 'tau_m', 'tau_h', 'tau_j', 'gamma_d', 'E_Ca', 'alpha_xr3', 'tau_d', 'KiMg', 'beta_xr3', 'KbMg', 'alpha_xr4', 'Kd1SPM', 'beta_xr4', 'Kd2SPM', 'OtoB', 'temp', 'BtoO', 'rec1', 'rec2', 'xK1_inf', 'i_K1', 'i_Kr', 'i_Ks', 'i_to', 'i_Na', 'i_b_Na', 'i_CaL', 'i_b_Ca', 'i_p_Ca', 'i_p_K', 'i_NaK', 'i_NaCa', 'i_tot', 'i_up', 'i_leak', 'i_xfer', 'Ca_i_bufc', 'kcasr', 'k1', 'k2', 'O', 'i_rel', 'Ca_sr_bufsr', 'Ca_ss_bufss']
        self.params = param
        self.T = T
        self.T_unit = T_unit
