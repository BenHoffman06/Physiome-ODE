...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[9e-13, 0, 0, 1e-13, 0, 0, 0, 1e-13, 1e-13, 1e-13, 0, 0.31, 99.4, 0.29, 100, 0, 100, 0, 96, 4],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "sedaghat_sherman_quon_2002"
        self.curve_names = [
            "x2",
            "x3",
            "x5",
        ...
        self.state_names = ['x2', 'x3', 'x5', 'x6', 'x4', 'x7', 'x8', 'x9', 'x10', 'x11', 'x12', 'x13', 'x14', 'x15', 'x16', 'x17', 'x18', 'x19', 'x20', 'x21']
        self.algebraic_names = ['x1', 'k5', 'k9', 'k11', 'k12', 'effect', 'k13b']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[22] = c[0]
        c[23] = 100.000*c[1]
        c[24] = (2.50000/7.45000)*c[9]
        c[25] = ((c[11]*5.00000)/70.7750)*1.00000e+12
        c[26] = (94.0000/3.10000)*c[17]
        c[27] = (3.10000/2.90000)*c[12]
        c[30] = (4.00000/96.0000)*c[15]
        c[31] = c[16]/96.0000
        c[32] = (0.310000/99.4000)*c[26]
