...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[1.892468811, 0.012871557, 0.053366179, 0.082791522, 0.159317029, 0.805117739, 10.25246999, 1.139360412, 6.146549084, 1.570847601, 1.835158493, 1.933616149, 5.571685096],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "wolf_sohn_heinrich_kuriyama_2001"
        self.curve_names = [
            "S1",
            "sul",
            "aps",
        ...
        self.state_names = ['S1', 'sul', 'aps', 'pap', 'hyd', 'cys', 'eth', 'aco', 'oxy', 'A3_c', 'A3_m', 'N2', 'oah']
        self.algebraic_names = ['S2', 'A2_c', 'A2_m', 'N1', 'f1', 'v1', 'v2', 'v3', 'v4', 'v5', 'v7', 'v17', 'v6', 'v8', 'v15', 'v9', 'f2', 'v18', 'v11A', 'v14', 'v11B', 'v12', 'v16']
        self.params = param
        self.T = T
        self.T_unit = T_unit
