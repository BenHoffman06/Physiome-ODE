...
class Parameters:
    def __init__(self):
        self.clamp = 1
        self.CO2_in = 0.0500000*0.0425000*(760.000-23.8000)*0.00100000
        self.MOPSt = 0.00000
        self.fracA = 0.0100000
        self.KgpA_glyf = 0.00170000
        self.KgpA_ipi = 0.00470000
        self.KgpA_g1p = 0.00270000
        self.KgpB_ipi = 0.00460000
        self.KgpB_ig1p = 0.00740000
        self.Kgp_amp = 6.46203e-06
        self.nH = 1.61590
        self.Kpfk_fbpT = 0.00402000
        self.Kpfk_adpT = 0.00270000
        self.Kpfki = 0.000870000*10.0000
        self.Kmpfk = 6.00000e-05
        self.d = 0.0100000
        self.e_ = 0.0100000
        self.Lo = 13.0000
        self.Kck_ipcr = 0.00390000
        self.Kck_Iadp = 1.50000e-05
        self.Kck_Ipcr = 0.00390000
        self.Kck_Icr = 0.0580000
        self.Kck_Iatp = 0.00434600
        self.Kck_Ii = 0.00100000
        self.kut = 0.124547
        self.VmaxOxPhos = 0.00378440
        self.Kmadp = 4.19392e-05
        self.nnHH = 2.21796
        self.Vmax_MCT = 0.000711494
        self.Klac1 = 0.00400000
        self.pKmct1 = 8.89000
        self.PSVCO2 = 2.30840
        self.X_CA = 740.000
        self.kf_hydrCO2 = 0.0469000*60.0000
        self.Flow = 0.00400000
        self.V_cell = 0.0550000*0.670000*0.00100000
        self.V_ec = 0.000149000-(0.0550000/1.06000)*0.00100000
        ...
        self.Vfgly = 0.00370000
        self.HCO3_in = 0.0300000
        self.Keq_CA = power(10.0000, -6.15700)
        self.KgpA_pi = 0.00400000
        self.KgpA_igly = 0.00200000
        self.KgpA_glyb = 0.000150000
        self.KgpA_ig1p = 0.0101000
        self.KgpB_pi = 0.000200000
        self.KgpB_iglyf = 0.0150000
        self.KgpB_g1p = 0.00150000
        self.KgpB_iglyb = 0.00440000
        self.Vffpglm = 0.00520000
        self.Kpglm_g1p = 6.30000e-05
        self.Kpglm_g6p = 3.00000e-05
        self.Vbbpgi = 0.383300
        self.Kpgi_g6p = 0.000480000
        self.Kpgi_f6p = 0.000119000
        self.Vffpfk = 0.00370000
        self.Kpfk_f6p = 0.000180000
        self.Kpfk_f6pT = 0.0200000
        self.Kpfk_atp = 8.00000e-05
        self.Kpfk_atpT = 0.000250000
        self.Kpfk_fbp = 0.00402000
        self.Kpfk_adp = 0.00270000
        self.Vffald = 0.0120000
        self.Kald_fbp = 5.00000e-05
        self.Kald_dhap = 0.00200000
        self.Kald_gap = 0.00100000
        self.Vfftpi = 0.140600
        self.Ktpi_gap = 0.000320000
        self.Ktpi_dhap = 0.000610000
        self.Vbbg3pdh = 0.0557000
        self.Kg3pdh_g3p = 0.000180000
        self.Kg3pdh_nad = 1.20000e-05
        self.Kg3pdh_dhap = 0.000220000
        self.Kg3pdh_nadh = 8.00000e-06
        self.Vffgad = 0.0765000
        self.Kgapdh_gap = 2.50000e-06
        self.Kgapdh_nad = 9.00000e-05
        self.Kgapdh_pi = 0.000290000
        self.Kgapdh_bpg = 8.00000e-07
        self.Kgapdh_nadh = 3.30000e-06
        self.Vbbpgk = 0.00870000
        self.Kpgk_bpg = 0.00200000
        self.Kpgk_adp = 8.00000e-06
        self.Kpgk_3pg = 0.00120000
        self.Kpgk_atp = 0.000350000
        self.Vffpgm = 0.0839000
        self.Kpgm_3pg = 0.000200000
        self.Kpgm_2pg = 1.40000e-05
        self.Vffen = 0.796600
        self.Ken_2pg = 0.000100000
        self.Ken_pep = 0.000370000
        self.Vffpk = 0.0408000
        self.Kpk_pep = 8.00000e-05
        self.Kpk_adp = 0.000300000
        self.Kpk_pyr = 0.00705000
        self.Kpk_atp = 0.00113000
        self.Vffldh = 0.0956000
        self.Kldh_pyr = 0.000335000
        self.Kldh_nadh = 2.00000e-06
        self.Kldh_lac = 0.0170000
        self.Kldh_nad = 0.000849000
        self.VforCK = 8.82150
        self.Kck_pcr = 0.00111000
        self.Kck_iatp = 0.00350000
        self.Kck_iadp = 0.000135000
        self.Kck_cr = 0.00380000
        self.Vfadk = 2.02990
        self.Kadk_amp = 0.000320000
        self.Kadk_atp = 0.000270000
        self.Kadk_adp = 0.000350000
        self.bufcapfixed = 0.00413880
        self.T = 298.150
        self.I = 0.170000
        self.k = 0.140000
        self.c0 = 1.00000
        ...
        self.slopeint_1 = 1000.00*2.04742
        self.slopeint_2 = 1000.00*0.0138384
        self.I25 = 0.250000
        self.RQ = 1.00000
        self.PO2ratio = 4.20000
    ...
    def to_dict(self):
        return {
            ...
            "MOPSt": self.MOPSt,
            "fracA": self.fracA,
            "KgpA_glyf": self.KgpA_glyf,
            "KgpA_ipi": self.KgpA_ipi,
            "KgpA_g1p": self.KgpA_g1p,
            "KgpB_ipi": self.KgpB_ipi,
            "KgpB_ig1p": self.KgpB_ig1p,
            "Kgp_amp": self.Kgp_amp,
            "nH": self.nH,
            "Kpfk_fbpT": self.Kpfk_fbpT,
            "Kpfk_adpT": self.Kpfk_adpT,
            "Kpfki": self.Kpfki,
            "Kmpfk": self.Kmpfk,
            "d": self.d,
            "e_": self.e_,
            "Lo": self.Lo,
            "Kck_ipcr": self.Kck_ipcr,
            "Kck_Iadp": self.Kck_Iadp,
            "Kck_Ipcr": self.Kck_Ipcr,
            "Kck_Icr": self.Kck_Icr,
            "Kck_Iatp": self.Kck_Iatp,
            "Kck_Ii": self.Kck_Ii,
            "kut": self.kut,
            "VmaxOxPhos": self.VmaxOxPhos,
            "Kmadp": self.Kmadp,
            "nnHH": self.nnHH,
            "Vmax_MCT": self.Vmax_MCT,
            "Klac1": self.Klac1,
            "pKmct1": self.pKmct1,
            "PSVCO2": self.PSVCO2,
            "X_CA": self.X_CA,
            "kf_hydrCO2": self.kf_hydrCO2,
            "Flow": self.Flow,
            "V_cell": self.V_cell,
            "V_ec": self.V_ec,
            ...
            "Vfgly": self.Vfgly,
            "HCO3_in": self.HCO3_in,
            "Keq_CA": self.Keq_CA,
            "KgpA_pi": self.KgpA_pi,
            "KgpA_igly": self.KgpA_igly,
            "KgpA_glyb": self.KgpA_glyb,
            "KgpA_ig1p": self.KgpA_ig1p,
            "KgpB_pi": self.KgpB_pi,
            "KgpB_iglyf": self.KgpB_iglyf,
            "KgpB_g1p": self.KgpB_g1p,
            "KgpB_iglyb": self.KgpB_iglyb,
            "Vffpglm": self.Vffpglm,
            "Kpglm_g1p": self.Kpglm_g1p,
            "Kpglm_g6p": self.Kpglm_g6p,
            "Vbbpgi": self.Vbbpgi,
            "Kpgi_g6p": self.Kpgi_g6p,
            "Kpgi_f6p": self.Kpgi_f6p,
            "Vffpfk": self.Vffpfk,
            "Kpfk_f6p": self.Kpfk_f6p,
            "Kpfk_f6pT": self.Kpfk_f6pT,
            "Kpfk_atp": self.Kpfk_atp,
            "Kpfk_atpT": self.Kpfk_atpT,
            "Kpfk_fbp": self.Kpfk_fbp,
            "Kpfk_adp": self.Kpfk_adp,
            "Vffald": self.Vffald,
            "Kald_fbp": self.Kald_fbp,
            "Kald_dhap": self.Kald_dhap,
            "Kald_gap": self.Kald_gap,
            "Vfftpi": self.Vfftpi,
            "Ktpi_gap": self.Ktpi_gap,
            "Ktpi_dhap": self.Ktpi_dhap,
            "Vbbg3pdh": self.Vbbg3pdh,
            "Kg3pdh_g3p": self.Kg3pdh_g3p,
            "Kg3pdh_nad": self.Kg3pdh_nad,
            "Kg3pdh_dhap": self.Kg3pdh_dhap,
            "Kg3pdh_nadh": self.Kg3pdh_nadh,
            "Vffgad": self.Vffgad,
            "Kgapdh_gap": self.Kgapdh_gap,
            "Kgapdh_nad": self.Kgapdh_nad,
            "Kgapdh_pi": self.Kgapdh_pi,
            "Kgapdh_bpg": self.Kgapdh_bpg,
            "Kgapdh_nadh": self.Kgapdh_nadh,
            "Vbbpgk": self.Vbbpgk,
            "Kpgk_bpg": self.Kpgk_bpg,
            "Kpgk_adp": self.Kpgk_adp,
            "Kpgk_3pg": self.Kpgk_3pg,
            "Kpgk_atp": self.Kpgk_atp,
            "Vffpgm": self.Vffpgm,
            "Kpgm_3pg": self.Kpgm_3pg,
            "Kpgm_2pg": self.Kpgm_2pg,
            "Vffen": self.Vffen,
            "Ken_2pg": self.Ken_2pg,
            "Ken_pep": self.Ken_pep,
            "Vffpk": self.Vffpk,
            "Kpk_pep": self.Kpk_pep,
            "Kpk_adp": self.Kpk_adp,
            "Kpk_pyr": self.Kpk_pyr,
            "Kpk_atp": self.Kpk_atp,
            "Vffldh": self.Vffldh,
            "Kldh_pyr": self.Kldh_pyr,
            "Kldh_nadh": self.Kldh_nadh,
            "Kldh_lac": self.Kldh_lac,
            "Kldh_nad": self.Kldh_nad,
            "VforCK": self.VforCK,
            "Kck_pcr": self.Kck_pcr,
            "Kck_iatp": self.Kck_iatp,
            "Kck_iadp": self.Kck_iadp,
            "Kck_cr": self.Kck_cr,
            "Vfadk": self.Vfadk,
            "Kadk_amp": self.Kadk_amp,
            "Kadk_atp": self.Kadk_atp,
            "Kadk_adp": self.Kadk_adp,
            "bufcapfixed": self.bufcapfixed,
            "T": self.T,
            "I": self.I,
            "k": self.k,
            "c0": self.c0,
            ...
            "slopeint_1": self.slopeint_1,
            "slopeint_2": self.slopeint_2,
            "I25": self.I25,
            "RQ": self.RQ,
            "PO2ratio": self.PO2ratio,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[7.14, 1e-3, 0.02, 0.0054, 1e-9, 1e-8, 1e-9, 1e-9, 0.0055, 1e-5, 1e-9, 1e-9, 1e-9, 1e-9, 0.0000000406654344, 0.000406654344, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 0.0075, 14.5e-3, 7.439766507222684, 0, 0.001564425, 30e-3, 0.001564425, 15e-3, 0, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "vinnakota_rusk_palmer_shankland_kushmeric_2010_soleus"
        self.curve_names = [
            "pH_calc",
            "mg",
            "Gly",
        ...
        self.state_names = ['pH_calc', 'mg', 'Gly', 'Pi', 'G1P', 'AMP', 'G6P', 'F6P', 'ATP', 'ADP', 'FBP', 'GAP', 'DHAP', 'G3P', 'NADH', 'NAD', 'BPG', 'P3G', 'P2G', 'PEP', 'PYR', 'LAC', 'Cr', 'PCr', 'pH_ec', 'LAC_ec', 'CO2_ec', 'HCO3_ec', 'CO2_cy', 'HCO3_cy', 'MOPS', 'MOPSH']
        self.algebraic_names = ['pH_cy', 'P_Pi', 'HPi2', 'H2Pi1', 'kPi', 'mgPi', 'Navg_Pi', 'dNavgPidH', 'deltaGpof_HPi2', 'P_ATP', 'ATP4', 'mgATP2', 'kATP', 'HATP3', 'Navg_ATP', 'dNavgATPdH', 'deltaGpof_ATP4', 'P_ADP', 'ADP3', 'mgADP', 'kADP', 'HADP2', 'Navg_ADP', 'dNavgADPdH', 'deltaGpof_ADP3', 'P_AMP', 'AMP2', 'mgAMP', 'HAMP1', 'Navg_AMP', 'dNavgAMPdH', 'deltaGpof_AMP2', 'P_PCR', 'HPCR', 'kPCR', 'mgPCR', 'H2PCR', 'Navg_PCR', 'dNavgPCRdH', 'P_CR', 'HCR', 'H2CR', 'Navg_CR', 'dNavgCRdH', 'P_G1P', 'UG1P', 'HG1P', 'mgG1P', 'Navg_G1P', 'dNavgG1PdH', 'deltaGpof_UG1P', 'P_G6P', 'UG6P', 'HG6P', 'Navg_G6P', 'dNavgG6PdH', 'deltaGpof_UG6P', 'P_F6P', 'UF6P', 'HF6P', 'Navg_F6P', 'dNavgF6PdH', 'deltaGpof_UF6P', 'P_FDP', 'UFDP', 'mgFDP', 'HFDP', 'Navg_FDP', 'dNavgFDPdH', 'deltaGpof_UFDP', 'P_GAP', 'UGAP', 'HGAP', 'Navg_GAP', 'dNavgGAPdH', 'deltaGpof_UGAP', 'P_G3P', 'UG3P', 'mgG3P', 'HG3P', 'Navg_G3P', 'dNavgG3PdH', 'deltaGpof_UG3P', 'P_DHAP', 'UDHAP', 'mgDHAP', 'HDHAP', 'Navg_DHAP', 'dNavgDHAPdH', 'deltaGpof_UDHAP', 'P_13DPG', 'U13DPG', 'H13DPG', 'Navg_13DPG', 'dNavg13DPGdH', 'deltaGpof_U13DPG', 'P_3PG', 'U3PG', 'H3PG', 'Navg_3PG', 'dNavg3PGdH', 'deltaGpof_U3PG', 'P_2PG', 'U2PG', 'H2PG', 'mg2PG', 'k2PG', 'Navg_2PG', 'dNavg2PGdH', 'deltaGpof_U2PG', 'P_PEP', 'UPEP', 'HPEP', 'kPEP', 'mgPEP', 'Navg_PEP', 'dNavgPEPdH', 'deltaGpof_UPEP', 'P_PYR', 'UPYR', 'HPYR', 'Navg_PYR', 'dNavgPYRdH', 'deltaGpof_UPYR', 'P_LAC', 'dmgLACdmg', 'dmgLACdpH', 'ULAC', 'mgLAC', 'HLAC', 'Navg_LAC', 'dNavgLACdH', 'deltaGpof_ULAC', 'deltaGpo_GLY', 'deltaGpof_NAD', 'deltaGpof_NADH', 'deltaGpof_H2O', 'deltaGpof_H', 'deltaH_CK', 'deltaGpo_ATPase', 'Kapp_CK', 'Kapp_ATPase', 'deltaH_ADK', 'deltaGpo_ADK', 'Kapp_ADK', 'deltaH_GP', 'deltaGpo_GP', 'Kapp_GP', 'deltaH_PGLM', 'deltaGpo_PGLM', 'Kapp_PGLM', 'deltaH_PGI', 'deltaGpo_PGI', 'Kapp_PGI', 'deltaH_PFK', 'deltaGpo_PFK', 'Kapp_PFK', 'deltaH_ALD', 'deltaGpo_ALD', 'Kapp_ALD', 'deltaH_TPI', 'deltaGpo_TPI', 'Kapp_TPI', 'deltaH_GAPDH', 'deltaGpo_GAPDH', 'Kapp_GAPDH', 'deltaH_G3PDH', 'deltaGpo_G3PDH', 'Kapp_G3PDH', 'deltaH_PGK', 'deltaGpo_PGK', 'Kapp_PGK', 'deltaH_PGM', 'deltaGpo_PGM', 'Kapp_PGM', 'deltaH_ENOL', 'deltaGpo_ENOL', 'Kapp_ENOL', 'deltaH_PK', 'deltaGpo_PK', 'Kapp_PK', 'deltaH_LDH', 'deltaGpo_LDH', 'Kapp_LDH', 'deltaH_ATPase', 'Dglya', 'pa', 'VbglyA', 'glyAF', 'glyAR', 'flux_GPa', 'M', 'Dglyb', 'pb', 'VbglyB', 'glyBF', 'glyBR', 'flux_GPb', 'dglydt', 'Vfpglm', 'Vbpglm', 'v_PGLM', 'dG1Pdt', 'Vbpgi', 'Vfpgi', 'v_PGI', 'dG6Pdt', 'Vfpfk', 'Vbpfk', 'L', 'Delta', 'Deltap', 'v_PFK', 'dF6Pdt', 'Vfald', 'Vbald', 'v_ALD', 'dFBPdt', 'Vbtpi', 'v_TPI', 'Dg3pdh', 'Vfg3pdh', 'v_G3PDH', 'dDHAPdt', 'dG3Pdt', 'Dgap', 'Vfgad', 'Vbgad', 'v_GAPDH', 'dGAPdt', 'Vfpgk', 'D_PGK', 'v_PGK', 'dBPGdt', 'Vfpgm', 'Vbpgm', 'v_PGM', 'dP3Gdt', 'Vben', 'v_ENOL', 'dP2Gdt', 'Vfpk', 'Vbpk', 'v_PK', 'dPEPdt', 'Vfldh', 'Vbldh', 'v_LDH', 'dNADdt', 'dNADHdt', 'dPYRdt', 'VrevCK', 'CK', 'dPCrdt', 'dCrdt', 'Vbadk', 'ADK', 'dAMPdt', 'ATPase', 'oxphos', 'v_MCT', 'dATPdt', 'dADPdt', 'dPidt', 'fluxO2', 'dLACdt', 'dLACecdt', 'fluxCO2', 'v_psCO2', 'v_hydrCO2cy', 'v_hydrCO2ec', 'bufcapmetab', 'dHCO3cydt', 'dCO2cydt', 'dHCO3ecdt', 'dCO2ecdt', 'v_MOPSbuff', 'CKprtflux', 'dMOPSdt', 'dMOPSHdt', 'dpHecdt', 'glycprtflux', 'protons_consumed', 'pHODEterm1', 'dpH_calcdt']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[145] = p.pKak_Pi
        c[146] = p.NH_HPi2
        c[147] = p.deltaGof_HPi2
        c[150] = p.NH_ATP4
        c[151] = p.deltaGof_ATP4
        c[152] = p.pKak_ADP
        c[154] = p.NH_ADP3
        c[155] = p.deltaGof_ADP3
        c[157] = p.NH_AMP2
        c[158] = p.deltaGof_AMP2
        c[159] = p.pKak_PCR
        c[161] = p.NH_HPCR
        c[162] = p.pKa1_CR
        c[163] = p.NH_HCR
        c[165] = p.NH_UG1P
        c[166] = p.deltaGof_UG1P
        c[168] = p.NH_UG6P
        c[169] = p.deltaGof_UG6P
        c[171] = p.NH_UF6P
        c[172] = p.deltaGof_UF6P
        c[173] = p.pKa1_FDP
        c[174] = p.NH_UFDP
        c[175] = p.deltaGof_UFDP
        c[176] = p.pKa1_GAP
        c[177] = p.NH_UGAP
        c[178] = p.deltaGof_UGAP
        c[180] = p.NH_UG3P
        c[181] = p.deltaGof_UG3P
        c[182] = p.pKa1_DHAP
        c[183] = p.NH_UDHAP
        c[184] = p.deltaGof_UDHAP
        c[185] = p.pKa1_13DPG
        c[186] = p.NH_U13DPG
        c[187] = p.deltaGof_U13DPG
        c[188] = p.pKa1_3PG
        c[189] = p.NH_U3PG
        c[190] = p.deltaGof_U3PG
        c[191] = p.pKa1_2PG
        c[192] = p.pKak_2PG
        c[193] = p.NH_U2PG
        c[194] = p.deltaGof_U2PG
        c[195] = p.pKa1_PEP
        c[196] = p.pKak_PEP
        c[197] = p.NH_UPEP
        c[198] = p.deltaGof_UPEP
        c[199] = p.pKa1_PYR
        c[200] = p.NH_UPYR
        c[201] = p.deltaGof_UPYR
        c[203] = p.NH_ULAC
        c[204] = p.deltaGof_ULAC
        c[205] = p.dNH_GLY
        c[206] = p.NH_NAD
        c[207] = p.deltaGof_NAD
        c[208] = p.NH_NADH
        c[209] = p.deltaGof_NADH
        c[210] = p.NH_H2O
        c[211] = p.deltaGof_H2O
        c[212] = p.NH_H
        c[213] = p.deltaGof_H
        c[214] = p.slopeint_1
        c[215] = p.slopeint_2
        ...
        c[47] = c[0]*0.00000
        c[50] = 1.00000-c[3]
        c[52] = power(10.0000, -c[30])
        c[53] = c[2]/2.00000
        c[54] = c[2]/2.00000
        c[55] = 6.15700+log(c[48]/c[1], 10)
        c[56] = c[33]/c[49]
        c[76] = (c[71]*c[73])/(c[72]*c[74])
        c[135] = (c[134]*((power(c[133], 1.0/2))/(1.00000+c[132]*(power(c[133], 1.0/2)))-(power(c[128], 1.0/2))/(1.00000+c[132]*(power(c[128], 1.0/2)))))/log(10.0000)
        c[136] = 1.65000+c[135]*((power(2.00000, 2.00000)+power(2.00000, 2.00000))-power(0.00000, 2.00000))
        c[138] = 4.19000+c[135]*((power(4.00000, 2.00000)+power(2.00000, 2.00000))-power(2.00000, 2.00000))
        c[139] = 3.25000+c[135]*((power(3.00000, 2.00000)+power(2.00000, 2.00000))-power(1.00000, 2.00000))
        c[140] = 1.92000+c[135]*((power(2.00000, 2.00000)+power(2.00000, 2.00000))-power(0.00000, 2.00000))
        c[141] = 1.60000+c[135]*((power(2.00000, 2.00000)+power(2.00000, 2.00000))-power(0.00000, 2.00000))
        c[142] = 2.48000+c[135]*((power(2.00000, 2.00000)+power(2.00000, 2.00000))-power(0.00000, 2.00000))
        c[143] = (c[137]*(power(c[128], 1.0/2)))/(1.00000+c[132]*(power(c[128], 1.0/2)))
        c[144] = 6.75000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[148] = 6.48000+c[135]*((power(4.00000, 2.00000)+power(1.00000, 2.00000))-power(3.00000, 2.00000))
        c[149] = 1.17000+c[135]*((power(4.00000, 2.00000)+power(1.00000, 2.00000))-power(3.00000, 2.00000))
        c[153] = 6.38000+c[135]*((power(3.00000, 2.00000)+power(1.00000, 2.00000))-power(2.00000, 2.00000))
        c[156] = 6.29000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[160] = 4.50000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[164] = 6.09000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[167] = 6.11000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[170] = 5.89000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[179] = 6.22000+c[135]*((power(2.00000, 2.00000)+power(1.00000, 2.00000))-power(1.00000, 2.00000))
        c[202] = 3.67000+c[135]*((power(1.00000, 2.00000)+power(1.00000, 2.00000))-power(0.00000, 2.00000))
        c[216] = exp(c[214]/c[127]+c[215])
        c[218] = (1.10708-0.00154508*c[127])+5.95584e-06*(power(c[127], 2.00000))
        c[219] = c[218]*((power(c[217], 1.0/2))/(1.00000+1.60000*(power(c[217], 1.0/2)))-(power(c[128], 1.0/2))/(1.00000+1.60000*(power(c[128], 1.0/2))))
        c[220] = -log(c[216])+c[219]*((((power(4.00000, 2.00000)+power(0.00000, 2.00000))-power(2.00000, 2.00000))-power(3.00000, 2.00000))-power(1.00000, 2.00000))
        c[221] = exp(-c[220])
        c[222] = -c[131]*c[127]*log(c[221])
        c[223] = c[82]
        c[224] = c[85]
        c[225] = c[96]
        c[226] = c[104]
