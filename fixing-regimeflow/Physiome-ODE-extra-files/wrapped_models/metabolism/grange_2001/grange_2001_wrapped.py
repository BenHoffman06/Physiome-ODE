...
class Parameters:
    ...
    def to_dict(self):
        return {
            "ka_b_dopa": self.ka_b_dopa,
            "Q": self.Q,
            "f_H": self.f_H,
            "CL_dopa_0": self.CL_dopa_0,
            "V_dopa": self.V_dopa,
            "CL_OMD_b": self.CL_OMD_b,
            "V_OMD_b": self.V_OMD_b,
            "ki": self.ki,
            "ka_Bens": self.ka_Bens,
            "F_Bens": self.F_Bens,
            "V1_B": self.V1_B,
            "CLd_B": self.CLd_B,
            "V2_B": self.V2_B,
...
class Config:
    def __init__(
        ...
        self.state_names = ['A_dopa_b', 'C_dopa_b', 'C_OMD_b', 'C_Ro_central', 'A_bens', 'C_bens_central', 'C_bens_peripheral', 'A_Ro', 'C_Ro_peripheral']
