...
class Parameters:
    def __init__(self):
        ...
        self.pH_C = 7
        self.K_c = 0.15
        self.k_PI1 = 0.1553e-3
        self.k_PI2 = 0.8222e-3
        self.k_PI3 = 0.3601e-3
        self.k_PI4 = 5.651e-3
        self.k_PIH = 2.542e-4
        self.r = 4.559
        self.X_DH = 0.0866
        ...
        self.W_m = 0.664000*1.09000
        self.W_c = 0.807000*1.04400
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[166.67, 0.0015723, 6.75e-4, 1.35e-3, 0.0026657, 0.0026046, 0.0073343, 0.0054765, 7, 0.14661, 1.0229e-3, 1.72e-4, 0.0065339, 0.0063812, 6.5773e-5, 4.8866e-5, 2.8837e-7, 1.72e-4, 0.0010029, 0.0081312, 6.85e-5, 3.0911e-7, 0.0079786, 5.1958e-5, 8.7702e-3, 0.001003, 23.589e-3],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "wu_jeneson_beard_2006"
        self.curve_names = [
            "deltaPsi",
            "NADH_x",
            "Q_x",
        ...
        self.state_names = ['deltaPsi', 'NADH_x', 'Q_x', 'Cox_x', 'ATP_x', 'ATP_mx', 'ADP_x', 'ADP_mx', 'pH_x', 'K_x', 'Mg_x', 'PI_x', 'ATP_i', 'ATP_mi', 'ADP_i', 'ADP_mi', 'AMP_i', 'PI_i', 'Mg_i', 'ATP_c', 'ADP_c', 'AMP_c', 'ATP_mc', 'ADP_mc', 'PI_c', 'Mg_c', 'PCr_c']
        self.algebraic_names = ['NAD_x', 'ATP_fc', 'QH2_x', 'ADP_fc', 'Cred_x', 'J_MgATP_c', 'ATP_fx', 'J_MgADP_c', 'ADP_fx', 'H_x', 'J_MgATP_x', 'dG_H', 'J_MgADP_x', 'dG_C1op', 'dG_C3op', 'dG_C4op', 'ATP_fi', 'ADP_fi', 'Cr_c', 'J_MgATP_i', 'J_DH', 'J_MgADP_i', 'J_C1', 'J_C3', 'J_C4', 'J_F1', 'Psi_x', 'Psi_i', 'J_ANT', 'H2PIi', 'J_AMP', 'H2PIx', 'J_ADP', 'J_PI1', 'J_ATP', 'J_Hle', 'J_AKi', 'J_PI2', 'J_AKc', 'J_KH', 'J_CKc', 'J_K']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[53] = 1.00000*(power(10.0000, -c[19]))
        c[54] = c[13]
        c[55] = c[20]
        c[57] = 0.900000*c[56]
        c[58] = 0.100000*c[56]
