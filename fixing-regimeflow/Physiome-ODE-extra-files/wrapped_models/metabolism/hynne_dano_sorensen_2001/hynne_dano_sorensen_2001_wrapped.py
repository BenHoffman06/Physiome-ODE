...
class Parameters:
    def __init__(self):
        ...
        self.K10_PEP = 0.2
        self.K10_ADP = 0.17
        self.V_10m = 3.43096E2
        self.K11 = 0.3
        self.V_11m = 5.31328E1
        self.K12_NADH = 0.1
        self.K12_ACA = 0.71
        self.V_12m = 8.98023E1
        self.k13 = 16.72
        self.K15_NADH = 0.13
        self.K15_INADH = 0.034
        self.K15_INAD = 0.13
        self.K15_DHAP = 25.0
        self.V_15m = 8.14797E1
        self.k16 = 1.9
        self.k18 = 24.7
        self.k20 = 2.83828E-3
        self.k22 = 2.25932
    ...
    def to_dict(self):
        return {
            "Glc_x_0": self.Glc_x_0,
            "CN_x_0": self.CN_x_0,
            "k0": self.k0,
            "K2_Glc": self.K2_Glc,
            "K2_IG6P": self.K2_IG6P,
            "K2_IIG6P": self.K2_IIG6P,
            "V_2m": self.V_2m,
            "P2": self.P2,
            "y_vol": self.y_vol,
            "K3_DGlc": self.K3_DGlc,
            "K3_Glc": self.K3_Glc,
            "K3_ATP": self.K3_ATP,
            "V_3m": self.V_3m,
            "V_4m": self.V_4m,
            ...
            "K6_eq": self.K6_eq,
            "K6_FBP": self.K6_FBP,
            "K6_DHAP": self.K6_DHAP,
            "K6_GAP": self.K6_GAP,
            "K6_IGAP": self.K6_IGAP,
            "V_6r": self.V_6r,
            "V_6f": self.V_6f,
            "K7_eq": self.K7_eq,
            "K7_DHAP": self.K7_DHAP,
            "K7_GAP": self.K7_GAP,
            "V_7m": self.V_7m,
            "K8_NAD": self.K8_NAD,
            "K8_NADH": self.K8_NADH,
            "K8_GAP": self.K8_GAP,
            "K8_BPG": self.K8_BPG,
            "K8_eq": self.K8_eq,
            "V_8m": self.V_8m,
            "k9f": self.k9f,
            "k9r": self.k9r,
            "K10_PEP": self.K10_PEP,
            "K10_ADP": self.K10_ADP,
            "V_10m": self.V_10m,
            "K11": self.K11,
            "V_11m": self.V_11m,
            "K12_NADH": self.K12_NADH,
            "K12_ACA": self.K12_ACA,
            "V_12m": self.V_12m,
            "k13": self.k13,
            "K15_NADH": self.K15_NADH,
            "K15_INADH": self.K15_INADH,
            "K15_INAD": self.K15_INAD,
            "K15_DHAP": self.K15_DHAP,
            "V_15m": self.V_15m,
            "k16": self.k16,
            "k18": self.k18,
            "k20": self.k20,
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[6.7, 0.573074, 4.2, 0.49, 4.64, 0.115, 2.95, 0.00027, 0.04, 8.7, 2.1, 1.5, 0.33, 5.20358, 1.48153, 1.28836, 19.2379, 16.4514, 4.196, 1.68478, 0.33, 0.65],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "hynne_dano_sorensen_2001"
        self.curve_names = [
            "Glc_x",
            "Glc",
            "G6P",
        ...
        self.state_names = ['Glc_x', 'Glc', 'G6P', 'F6P', 'FBP', 'GAP', 'DHAP', 'BPG', 'PEP', 'Pyr', 'ATP', 'ADP', 'AMP', 'CN_x', 'ACA', 'ACA_x', 'EtOH', 'EtOH_x', 'Glyc', 'Glyc_x', 'NADH', 'NAD']
        self.algebraic_names = ['inGlc', 'GlcTrans', 'HK', 'PGI', 'PFK', 'ALD', 'TIM', 'GAPDH', 'lpPEP', 'PK', 'storage', 'PDC', 'consum', 'ADH', 'lpGlyc', 'AK', 'outACA', 'outEtOH', 'difACA', 'difEtOH', 'outGlyc', 'lacto', 'difGlyc', 'inCN']
        self.params = param
        self.T = T
        self.T_unit = T_unit
