...
class Parameters:
    def __init__(self):
        self.mu = 1.0
        self.K_NADP_1 = 0.116
        self.Ki_NADPH_1 = 1.702
        self.Ki_MgATP_1 = 0.33
        self.rmax_G6PDH = 44.19
        self.K_NADP_2 = 1.848
        self.Ki_NADPH_2 = 0.055
        self.Ki_MgATP_2 = 0.109
        self.rmax_6PGDH = 0.654
        self.rmax_R5PI = 0.57
        self.rmax_Ru5PE = 0.85
        self.rmax_TKL1 = 3.24
        self.C_GAP = 0.064
        self.rmax_TAL = 3.0
        self.rmax_TKL2 = 10.5
        self.K_PKDA = 0.0032
        self.rmax_PKDA = 0.004
        self.K_RPPK = 0.0034
        self.rmax_RPPK = 0.003

    def to_dict(self):
        return {
            "mu": self.mu,
            "K_NADP_1": self.K_NADP_1,
            "Ki_NADPH_1": self.Ki_NADPH_1,
            "Ki_MgATP_1": self.Ki_MgATP_1,
            "rmax_G6PDH": self.rmax_G6PDH,
            "K_NADP_2": self.K_NADP_2,
            "Ki_NADPH_2": self.Ki_NADPH_2,
            "Ki_MgATP_2": self.Ki_MgATP_2,
            "rmax_6PGDH": self.rmax_6PGDH,
            "rmax_R5PI": self.rmax_R5PI,
            "rmax_Ru5PE": self.rmax_Ru5PE,
            "rmax_TKL1": self.rmax_TKL1,
            "C_GAP": self.C_GAP,
            "rmax_TAL": self.rmax_TAL,
            "rmax_TKL2": self.rmax_TKL2,
            "K_PKDA": self.K_PKDA,
            "rmax_PKDA": self.rmax_PKDA,
            "K_RPPK": self.K_RPPK,
            "rmax_RPPK": self.rmax_RPPK,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[0.25, 0.033, 0.118, 0.041, 0.082, 0.029, 0.9, 0.168, 0.168, 2.3],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "vaseghi_baumeister_rizzi_reuss_1999"
        self.curve_names = [
            "C_6PG",
            "C_Ru5P",
            "C_R5P",
        ...
        self.state_names = ['C_6PG', 'C_Ru5P', 'C_R5P', 'C_X5P', 'C_S7P', 'C_E4P', 'C_G6P', 'C_NADP', 'C_NADPH', 'C_MgATP']
        self.algebraic_names = ['dC_G6P_dt', 'I_NADPH_1', 'I_MgATP_1', 'rG6PDH', 'I_NADPH_2', 'qs', 'I_MgATP_2', 'rHK', 'rPGI', 'r6PGDH', 'rR5PI', 'rRu5PE', 'rTKL1', 'rRPPK', 'rTAL', 'rTKL2', 'rPKDA']
        self.params = param
        self.T = T
        self.T_unit = T_unit
