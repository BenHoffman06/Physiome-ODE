...
def initConsts():
    ...
    constants[2] = 1.00000
    constants[3] = 7.30000
    constants[4] = 1.90000*0.0500000
    constants[5] = 0.00200000
...
class Parameters:
    def __init__(self):
        ...
        self.Par_97 = 1.00000
        self.Par_98 = 7.30000
        self.Par_1 = 1.90000*0.0500000
        self.Par_2 = 0.00200000
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[7.3, 4.913450725e-4, 1e-9, 0.035, 0.04, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 0.005, 1e-9, 1e-9, 1e-9, 0.0005, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 0.029999999, 1e-9, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "vinnakota_kemp_kushmeric_2006_exp45"
        self.curve_names = [
            "pH_calc",
            "Mg",
            "G1P",
