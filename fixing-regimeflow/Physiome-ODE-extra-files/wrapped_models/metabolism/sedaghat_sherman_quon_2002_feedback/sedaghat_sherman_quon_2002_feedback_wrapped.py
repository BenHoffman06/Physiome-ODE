...
class Parameters:
    def __init__(self):
        ...
        self.k3 = 2500
        self.k4b = 2.1e-3
        self.k_minus4b = 2.1e-4
        self.k_minus5 = 1.67e-18
        self.k6 = 0.461
        self.k7 = 4.16
        self.IRp = 8.97e-13
        self.k_minus8 = 10
        ...
        self.PTEN = 1
        self.SHIP = 1
        self.k_minus13 = 0.167
        self.k_minus14 = 0.001155
        self.V_max = 20
        self.K_d = 12
        self.n = 4
        self.tau = 1.5
        self.k9_stimulated = 1.39
        self.APequil = 9.09
        self.k7b = log(2.00000)/2.00000
        self.k_minus11 = 10.0000*log(2.00000)*1.00000
        self.k_minus12 = 10.0000*log(2.00000)*1.00000

    def to_dict(self):
        return {
            "k1": self.k1,
            "k_minus1": self.k_minus1,
            "k_minus4": self.k_minus4,
            "k3": self.k3,
            "k4b": self.k4b,
            "k_minus4b": self.k_minus4b,
            "k_minus5": self.k_minus5,
            "k6": self.k6,
            "k7": self.k7,
            "IRp": self.IRp,
            "k_minus8": self.k_minus8,
            "k_minus10": self.k_minus10,
            "PTEN": self.PTEN,
            "SHIP": self.SHIP,
            "k_minus13": self.k_minus13,
            "k_minus14": self.k_minus14,
            "V_max": self.V_max,
            "K_d": self.K_d,
            "n": self.n,
            "tau": self.tau,
            "k9_stimulated": self.k9_stimulated,
            "APequil": self.APequil,
            "k7b": self.k7b,
            "k_minus11": self.k_minus11,
            "k_minus12": self.k_minus12,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[9e-13, 0, 0, 1e-13, 0, 0, 0, 1e-12, 0, 0, 1e-13, 2.54e-15, 0.31, 99.4, 0.29, 100, 0, 100, 0, 96, 4],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "sedaghat_sherman_quon_2002_feedback"
        self.curve_names = [
            "x2",
            "x3",
            "x5",
        ...
        self.state_names = ['x2', 'x3', 'x5', 'x6', 'x4', 'x7', 'x8', 'x9', 'x10', 'x10a', 'x11', 'x12', 'x13', 'x14', 'x15', 'x16', 'x17', 'x18', 'x19', 'x20', 'x21']
        self.algebraic_names = ['x1', 'k9', 'k11', 'k12', 'effect', 'PTP', 'k13b', 'k5', 'PKC']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[24] = c[0]
        c[25] = 100.000*c[1]
        c[26] = (2.50000/7.45000)*c[8]
        c[28] = ((c[10]*5.00000)/70.7750)*1.00000e+12
        c[29] = (94.0000/3.10000)*c[20]
        c[30] = (3.10000/2.90000)*c[11]
        c[33] = (4.00000/96.0000)*c[14]
        c[34] = c[15]/96.0000
        c[35] = (((c[27]*2.50000)/7.45000)*3.70000e-13)/(6.27000e-13-(2.50000/7.45000)*3.70000e-13)
        c[36] = (0.310000/99.4000)*c[29]
        c[37] = (c[28]*3.70000e-13*1.00000e-13)/(c[28]*3.70000e-13+c[10])
