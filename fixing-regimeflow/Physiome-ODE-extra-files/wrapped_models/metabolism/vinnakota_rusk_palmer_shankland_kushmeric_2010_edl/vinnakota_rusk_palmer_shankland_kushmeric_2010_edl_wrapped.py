...
class Parameters:
    def __init__(self):
        ...
        self.kut = 0.0827000
        self.VmaxOxPhos = 0.00370000
        self.Kmadp = 4.83390e-05
        self.nnHH = 2.42900
        self.Vmax_MCT = 0.00462138
        self.Klac1 = 0.0255000
        self.pKmct1 = 8.89000
        self.PSVCO2 = 2.30840
        self.X_CA = 740.000
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[7.14, 1e-3, 0.026, 0.0016, 1e-9, 1e-8, 1e-9, 1e-9, 0.0083, 1e-5, 1e-9, 1e-9, 1e-9, 1e-9, 0.000000079297597, 0.00079297597, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 1e-9, 0.0149, 28e-3, 7.439766507222684, 0, 0.001564425, 30e-3, 0.001564425, 15e-3, 0, 0],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "vinnakota_rusk_palmer_shankland_kushmeric_2010_edl"
        self.curve_names = [
            "pH_calc",
            "mg",
            "Gly",
