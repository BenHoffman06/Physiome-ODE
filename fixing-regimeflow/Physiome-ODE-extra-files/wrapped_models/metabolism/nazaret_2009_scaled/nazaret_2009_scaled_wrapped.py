...
class Parameters:
    ...
    def to_dict(self):
        return {
            "At": self.At,
            "Nt": self.Nt,
            "Pyr_bar": self.Pyr_bar,
            "Cit_bar": self.Cit_bar,
            "AcCoA_bar": self.AcCoA_bar,
            "KG_bar": self.KG_bar,
            "OAA_bar": self.OAA_bar,
            "k1": self.k1,
            "k2": self.k2,
            "k3": self.k3,
            "k4": self.k4,
...
class Config:
    def __init__(
        ...
        self.model_name = "nazaret_2009_scaled"
        self.curve_names = [
            "p",
            "a",
            "c",
        ...
        self.state_names = ['p', 'a', 'c', 'k', 'o', 'n', 'en', 's']
        self.algebraic_names = ['time', 'v2', 'v3', 'v4', 'v5', 'v6', 'v7', 'v8', 'vANT', 'vleak', 'vresp', 'en_crit', 'vATP']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        # derived constants
        c[31] = (c[8]/c[7])*c[1]*c[2]
        c[32] = (c[9]/c[7])*c[6]*c[4]
        c[33] = (c[10]/c[7])*c[1]*c[3]
        c[34] = (c[11]/c[7])*c[1]*c[0]*c[5]
        c[35] = c[5]/(c[6]*c[19])
        c[36] = (c[12]/c[7])*c[6]
        c[37] = (c[13]/c[7])*c[0]*c[2]
        c[38] = (c[14]/c[7])*c[6]
        c[39] = (c[17]/c[7])*c[0]
        c[40] = (c[18]/c[7])*c[23]
        c[41] = c[15]/c[7]
        ...
        c[45] = c[22]*c[0]
        c[46] = c[28]*c[29]
        c[47] = 3.00000*((1.20000*c[26]*c[23])/(c[24]*c[25]))
        c[48] = c[4]/c[2]
        c[49] = c[3]/c[2]
        c[50] = c[5]/c[2]
        c[51] = c[6]/c[2]
