...
class Parameters:
    def __init__(self):
        ...
        self.K_DHAP = 2.0
        self.Keq_ALD = 9.5E-5
        self.V_max_f_4 = 104.0
        self.K_GAP_1 = 0.32
        self.K_DHAP_1 = 0.61
        self.Keq_TPI = 0.052
        self.V_max_f_5 = 12000.0
        self.K_GAP_2 = 0.0025
        self.K_Pi_2 = 0.29
        self.K_NAD = 0.09
        self.K_NADH = 0.0033
        self.K_Thirteen_BPG = 0.0008
        self.Keq_GAPDH = 0.089
        self.V_max_f_6 = 1265.0
        self.K_three_PG = 1.2
        self.K_ADP_1 = 0.008
        self.K_ATP_1 = 0.35
        self.K_Thirteen_BPG_1 = 0.002
        self.Keq_PGK = 57109.0
        self.V_max_r_1 = 1120.0
        self.K_two_PG = 0.014
        self.K_three_PG_1 = 0.2
        self.Keq_PGM = 0.18
        self.V_max_f_7 = 1120.0
        self.K_PEP = 0.37
        self.K_two_PG_1 = 0.1
        self.Keq_ENOL = 0.49
        self.V_max_f_8 = 192.0
        self.K_PYR = 7.05
        self.K_ADP_2 = 0.3
        self.K_ATP_2 = 1.13
        self.K_PEP_1 = 0.08
        self.Keq_PK = 10304.0
        self.V_max_f_9 = 1440.0
        self.K_LAC = 17.0
        self.K_NADH_1 = 0.002
        self.K_NAD_1 = 0.849
        self.K_PYR_1 = 0.335
        self.Keq_LDH = 16198.0
        self.V_max_f_10 = 1920.0
        self.Ki_ADP = 0.135
        self.K_Cr = 3.8
        self.K_PCr = 1.11
        self.Ki_PCr = 3.9
        self.Ki_ATP_1 = 3.5
        self.Keq_CK = 233.0
        self.V_max_r_2 = 500.0
        self.K_ADP_3 = 0.35
        self.K_AMP_1 = 0.32
        self.K_ATP_3 = 0.27
        self.Keq_ADK = 2.21
        self.V_max_f_11 = 880.0
    ...
    def to_dict(self):
        return {
            ...
            "frac_a": self.frac_a,
            "frac_b": self.frac_b,
            "Ki_GLY_f": self.Ki_GLY_f,
            "Ki_GLY_b": self.Ki_GLY_b,
            "K_GLY_f": self.K_GLY_f,
            "K_GLY_b": self.K_GLY_b,
            "Keq_GP": self.Keq_GP,
            "Ki_Pi": self.Ki_Pi,
            "K_Pi": self.K_Pi,
            "Ki_G1P": self.Ki_G1P,
            "V_max_f": self.V_max_f,
            "Ki_GLY_f_1": self.Ki_GLY_f_1,
            "Ki_GLY_b_1": self.Ki_GLY_b_1,
            "K_GLY_f_1": self.K_GLY_f_1,
            "Keq_GP_1": self.Keq_GP_1,
            "nH": self.nH,
            "K_AMP": self.K_AMP,
            "K_GLY_b_1": self.K_GLY_b_1,
            "Ki_Pi_1": self.Ki_Pi_1,
            "K_Pi_1": self.K_Pi_1,
            "Ki_G1P_1": self.Ki_G1P_1,
            "K_G1P": self.K_G1P,
            "V_max_f_1": self.V_max_f_1,
            "K_G1P_1": self.K_G1P_1,
            "K_G6P": self.K_G6P,
            "Keq_PGLM": self.Keq_PGLM,
            "V_max_f_2": self.V_max_f_2,
            "K_G6P_1": self.K_G6P_1,
            "K_F6P": self.K_F6P,
            "Keq_PGI": self.Keq_PGI,
            "V_max_r": self.V_max_r,
            "K_FBP": self.K_FBP,
            "K_FBP_": self.K_FBP_,
            "K_F6P_1": self.K_F6P_1,
            "K_ATP": self.K_ATP,
            "K_F6P_": self.K_F6P_,
            "K_ATP_": self.K_ATP_,
            "K_ADP": self.K_ADP,
            ...
            "Ki_ATP": self.Ki_ATP,
            "Ka_AMP": self.Ka_AMP,
            "V_max_f_3": self.V_max_f_3,
            "Lo": self.Lo,
            "d": self.d,
            "var_e": self.var_e,
            "K_GAP": self.K_GAP,
            "K_FBP_1": self.K_FBP_1,
            "K_DHAP": self.K_DHAP,
            "Keq_ALD": self.Keq_ALD,
            "V_max_f_4": self.V_max_f_4,
            "K_GAP_1": self.K_GAP_1,
            "K_DHAP_1": self.K_DHAP_1,
            "Keq_TPI": self.Keq_TPI,
            "V_max_f_5": self.V_max_f_5,
            "K_GAP_2": self.K_GAP_2,
            "K_Pi_2": self.K_Pi_2,
            "K_NAD": self.K_NAD,
            "K_NADH": self.K_NADH,
            "K_Thirteen_BPG": self.K_Thirteen_BPG,
            "Keq_GAPDH": self.Keq_GAPDH,
            "V_max_f_6": self.V_max_f_6,
            "K_three_PG": self.K_three_PG,
            "K_ADP_1": self.K_ADP_1,
            "K_ATP_1": self.K_ATP_1,
            "K_Thirteen_BPG_1": self.K_Thirteen_BPG_1,
            "Keq_PGK": self.Keq_PGK,
            "V_max_r_1": self.V_max_r_1,
            "K_two_PG": self.K_two_PG,
            "K_three_PG_1": self.K_three_PG_1,
            "Keq_PGM": self.Keq_PGM,
            "V_max_f_7": self.V_max_f_7,
            "K_PEP": self.K_PEP,
            "K_two_PG_1": self.K_two_PG_1,
            "Keq_ENOL": self.Keq_ENOL,
            "V_max_f_8": self.V_max_f_8,
            "K_PYR": self.K_PYR,
            "K_ADP_2": self.K_ADP_2,
            "K_ATP_2": self.K_ATP_2,
            "K_PEP_1": self.K_PEP_1,
            "Keq_PK": self.Keq_PK,
            "V_max_f_9": self.V_max_f_9,
            "K_LAC": self.K_LAC,
            "K_NADH_1": self.K_NADH_1,
            "K_NAD_1": self.K_NAD_1,
            "K_PYR_1": self.K_PYR_1,
            "Keq_LDH": self.Keq_LDH,
            "V_max_f_10": self.V_max_f_10,
            "Ki_ADP": self.Ki_ADP,
            "K_Cr": self.K_Cr,
            "K_PCr": self.K_PCr,
            "Ki_PCr": self.Ki_PCr,
            "Ki_ATP_1": self.Ki_ATP_1,
            "Keq_CK": self.Keq_CK,
            "V_max_r_2": self.V_max_r_2,
            "K_ADP_3": self.K_ADP_3,
            "K_AMP_1": self.K_AMP_1,
            "K_ATP_3": self.K_ATP_3,
            "Keq_ADK": self.Keq_ADK,
            "V_max_f_11": self.V_max_f_11,
        }
...
class Config:
    def __init__(
        ...
        T: int = 100,
        T_unit: float = 0.01,
        y0=[112.0, 0.0589, 0.75, 0.228, 0.0723, 0.0764, 0.0355, 0.065, 0.052, 0.005, 0.0194, 0.0994, 1.3, 4.1, 0.013, 8.2, 0.99, 34.67, 35.0, 0.001, 0.5],
    ):
        if param is None:
            raise ValueError("Config requires param=Parameters()")

        self.model_name = "lambeth_kushmerick_2002"
        self.curve_names = [
            "GLY",
            "G1P",
            "G6P",
        ...
        self.state_names = ['GLY', 'G1P', 'G6P', 'F6P', 'FBP', 'DHAP', 'GAP', 'Thirteen_BPG', 'three_PG', 'two_PG', 'PEP', 'PYR', 'LAC', 'Pi', 'ADP', 'ATP', 'AMP', 'PCr', 'Cr', 'NADH', 'NAD']
        self.algebraic_names = ['output', 'V_GPa', 'V_GPb', 'flux_GP', 'V_PGLM', 'V_PGI', 'delta', 'delta_', 'L', 'V_PFK', 'V_ALD', 'V_TPI', 'D_GAPDH', 'V_GAPDH', 'V_PGK', 'V_PGM', 'V_ENOL', 'V_PK', 'V_LDH', 'V_CK', 'V_ADK']
        self.params = param
        self.T = T
        self.T_unit = T_unit
    ...
    def _build_constants(self):
        ...
        c[57] = p.K_NAD
        c[58] = p.K_NADH
        c[59] = p.K_Thirteen_BPG
        c[60] = p.Keq_GAPDH
        c[61] = p.V_max_f_6
        c[62] = p.K_three_PG
        c[63] = p.K_ADP_1
        c[64] = p.K_ATP_1
        c[65] = p.K_Thirteen_BPG_1
        c[66] = p.Keq_PGK
        c[67] = p.V_max_r_1
        c[68] = p.K_two_PG
        c[69] = p.K_three_PG_1
        ...
        # derived constants
        c[100] = (c[11]*c[6]*c[10])/(c[3]*c[9]*c[7])
        c[101] = (c[23]*c[13]*c[22])/(c[14]*c[19]*c[15])
        c[102] = (c[27]*c[25])/(c[24]*c[26])
        c[103] = (c[31]*c[28]*c[30])/c[29]
        c[104] = (c[42]*c[38]*c[32])/(c[35]*c[34])
        c[105] = (c[34]*c[35])/(c[36]*c[37])
        c[106] = (c[50]*c[48]*c[46])/(c[47]*c[49])
        c[107] = (c[54]*c[52])/(c[51]*c[53])
        c[108] = (c[61]*1.00000*c[59]*c[58])/(c[55]*c[57]*c[56]*c[60])
        c[109] = (c[67]*c[65]*c[63]*c[66])/(c[62]*c[64])
        c[110] = (c[71]*c[68])/(c[69]*c[70])
        c[111] = (c[75]*c[72])/(c[73]*c[74])
        c[112] = (c[81]*c[78]*c[76])/(c[79]*c[77]*c[80])
        c[113] = (c[87]*c[82]*c[84])/(c[85]*c[83]*c[86])
        c[114] = (c[94]*c[92]*c[89]*c[93])/(c[88]*c[90])
        c[115] = (c[99]*(power(c[95], 2.00000)))/(c[97]*c[96]*c[98])
